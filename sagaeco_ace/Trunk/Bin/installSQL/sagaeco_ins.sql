...
CREATE TABLE `char` (
  ...
  `dominionlv` tinyint(3) unsigned NOT NULL default '1',
  ...
  `dominionjlv` tinyint(3) unsigned NOT NULL default '1',
  ...
  `dstr` smallint(5) unsigned NOT NULL default '0',
  `ddex` smallint(5) unsigned NOT NULL default '0',
  `dintel` smallint(5) unsigned NOT NULL default '0',
  `dvit` smallint(5) unsigned NOT NULL default '0',
  `dagi` smallint(6) unsigned NOT NULL default '0',
  `dmag` smallint(6) unsigned NOT NULL default '0',
  `statspoint` smallint(5) unsigned NOT NULL default '0',
  `dstatpoint` smallint(5) unsigned NOT NULL default '0',
  ...
  `dcexp` bigint(10) unsigned NOT NULL default '0',
  `djexp` bigint(10) unsigned NOT NULL default '0',
