...
namespace SagaMap.Tasks.PC
{
    public class CityRecover : MultiRunTask
    {
        ...
        public override void  CallBack()
        {
            ...
            try
            {
                if (!client.Character.Buff.NoRegen)
                {
                    ...
                    this.client.Character.SP < this.client.Character.MaxSP)
                    {
                        this.client.Character.HP += (uint)(this.client.Character.MaxHP * (100 + ((this.client.Character.Vit +
                            this.client.Character.Status.vit_item + this.client.Character.Status.vit_mario +
                        ...
                        this.client.Character.MP += (uint)(this.client.Character.MaxMP * (100 + ((this.client.Character.Mag +
                         this.client.Character.Status.mag_item + this.client.Character.Status.mag_mario +
                        ...
                        this.client.Character.SP += (uint)(this.client.Character.MaxSP * (100 + ((this.client.Character.Int +
                          this.client.Character.Vit + this.client.Character.Status.int_item + this.client.Character.Status.int_mario +
                          this.client.Character.Status.int_rev + this.client.Character.Status.vit_rev + this.client.Character.Status.vit_mario +
