...
namespace SagaMap.Skill.Additions.Global
{
    ...
    public class IaiMode : DefaultBuff
    {
        ...
        void StartEvent(Actor actor, DefaultBuff skill)
        {
            ...
            //最大攻擊
            int max_atk1_add = (int)(actor.Status.max_atk_ori * rate);
            ...
            //最大攻擊
            int max_atk2_add = (int)(actor.Status.max_atk_ori * rate);
            ...
            //最大攻擊
            int max_atk3_add = (int)(actor.Status.max_atk_ori * rate);
            ...
            //最小攻擊
            int min_atk1_add = (int)(actor.Status.min_atk_ori * rate);
            ...
            //最小攻擊
            int min_atk2_add = (int)(actor.Status.min_atk_ori * rate);
            ...
            //最小攻擊
            int min_atk3_add = (int)(actor.Status.min_atk_ori * rate);
        ...
        void EndEvent(Actor actor, DefaultBuff skill)
        {
            ...
            if (actor.type == ActorType.PC)
            {
                SagaMap.Network.Client.MapClient.FromActorPC((ActorPC)actor).SendSystemMessage("居合姿势取消。"); actor.Speed = 600;
                if (((ActorPC)actor).Skills.ContainsKey(2178))
