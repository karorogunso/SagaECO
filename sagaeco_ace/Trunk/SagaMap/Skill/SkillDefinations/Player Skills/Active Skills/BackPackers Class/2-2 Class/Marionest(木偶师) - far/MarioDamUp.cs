...
namespace SagaMap.Skill.SkillDefinations.Marionest
{
    ...
    public class MarioDamUp : ISkill
    {
        ...
        void StartEventHandler(Actor actor, DefaultPassiveSkill skill)
        {
            ...
            //最大攻擊
            int max_atk1_add = (int)(actor.Status.max_atk_ori  * (0.07f + 0.03f * level));
            ...
            //最大攻擊
            int max_atk2_add = (int)(actor.Status.max_atk_ori * (0.07f + 0.03f * level));
            ...
            //最大攻擊
            int max_atk3_add = (int)(actor.Status.max_atk_ori * (0.07f + 0.03f * level));
            ...
            //最小攻擊
            int min_atk1_add = (int)(actor.Status.min_atk_ori  * (0.07f + 0.03f * level));
            ...
            //最小攻擊
            int min_atk2_add = (int)(actor.Status.min_atk_ori * (0.07f + 0.03f * level));
            ...
            //最小攻擊
            int min_atk3_add = (int)(actor.Status.min_atk_ori * (0.07f + 0.03f * level));
