...
namespace SagaMap.Skill.SkillDefinations.DarkStalker
{
    ...
    public class HpDownToDamUp : ISkill
    {
        ...
        void StartEventHandler(Actor actor, DefaultPassiveSkill skill)
        {
            ...
            //最大攻擊
            int max_atk1_add = (int)(actor.Status.max_atk_ori  * damUP);
            ...
            //最大攻擊
            int max_atk2_add = (int)(actor.Status.max_atk_ori * damUP);
            ...
            //最大攻擊
            int max_atk3_add = (int)(actor.Status.max_atk_ori * damUP);
            ...
            //最小攻擊
            int min_atk1_add = (int)(actor.Status.min_atk_ori  * damUP);
            ...
            //最小攻擊
            int min_atk2_add = (int)(actor.Status.min_atk_ori * damUP);
            ...
            //最小攻擊
            int min_atk3_add = (int)(actor.Status.min_atk_ori * damUP);
