...
namespace SagaMap.Skill.SkillDefinations.Command
{
    ...
    public class MartialArtDamUp : ISkill 
    {
        ...
        void StartEventHandler(Actor actor, DefaultPassiveSkill skill)
        {
            ...
            //最小攻擊
            int min_atk1_add = (int)(actor.Status.min_atk1 * 0.1f * level);
            ...
            //最小攻擊
            int min_atk2_add = (int)(actor.Status.min_atk2 * 0.1f * level);
            ...
            //最小攻擊
            int min_atk3_add = (int)(actor.Status.min_atk3 * 0.1f * level);
