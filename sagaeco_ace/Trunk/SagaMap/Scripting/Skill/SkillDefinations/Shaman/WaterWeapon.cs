...
namespace SagaMap.Skill.SkillDefinations.Shaman
{
    public class WaterWeapon:ISkill
    {
        ...
        public void Proc(Actor sActor, Actor dActor, SkillArg args, byte level)
        {
            ...
            DefaultBuff skill = new DefaultBuff(args.skill, dActor, "WaterWeapon", 50000);
        ...
        void StartEventHandler(Actor actor, DefaultBuff skill)
        {
            ...
            actor.AttackElements[SagaLib.Elements.Water] += atk;
        ...
        void EndEventHandler(Actor actor, DefaultBuff skill)
        {
            ...
            actor.AttackElements[SagaLib.Elements.Water] -= value;
