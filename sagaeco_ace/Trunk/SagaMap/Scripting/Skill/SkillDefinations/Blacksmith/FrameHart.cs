...
namespace SagaMap.Skill.SkillDefinations.Blacksmith
{
    ...
    public class FrameHart : ISkill 
    {
        ...
        void StartEventHandler(Actor actor, DefaultBuff skill)
        {
            ...
            int max_atk1_add = (int)(actor.Status.max_atk_ori  * (0.04 + 0.1 * level));
            int min_atk1_add = (int)(actor.Status.min_atk_ori  * (0.04 + 0.1 * level));
            int max_atk2_add = (int)(actor.Status.max_atk_ori * (0.04 + 0.1 * level));
            int min_atk2_add = (int)(actor.Status.min_atk_ori * (0.04 + 0.1 * level));
            int max_atk3_add = (int)(actor.Status.max_atk_ori * (0.04 + 0.1 * level));
            int min_atk3_add = (int)(actor.Status.min_atk_ori * (0.04 + 0.1 * level));
