...
namespace SagaMap.Skill.SkillDefinations.Assassin
{
    ...
    public class AvoidUp : ISkill 
    {
        ...
        void StartEventHandler(Actor actor, DefaultPassiveSkill skill)
        {
            ...
            int avoid_melee_add = (int)(actor.Status.avoid_melee * avoid_melee_adds[skill.skill.Level ]);
            ...
            int avoid_ranged_add = (int)(actor.Status.avoid_ranged * avoid_ranged_adds[skill.skill.Level]);
