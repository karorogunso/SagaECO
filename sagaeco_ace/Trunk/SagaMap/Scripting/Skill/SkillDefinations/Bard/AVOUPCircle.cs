...
namespace SagaMap.Skill.SkillDefinations.Bard
{
    ...
    public class AVOUPCircle : ISkill
    {
        ...
        public void Proc(Actor sActor, Actor dActor, SkillArg args, byte level)
        {
            ...
            //註冊施放者的Buff
            DefaultBuff skill = new DefaultBuff(args.skill, sActor, "AVOUPCircle_Caster", 6000 + 2000 * level);
                ...
                try
                {
                    if (count < countMax)
                    {
                        ...
                        foreach (Actor act in actors)
                        {
                            ...
                            {
                                if (!act.Status.Additions.ContainsKey("AVOUPCircle"))
                                {
                                    DefaultBuff skill2 = new DefaultBuff(skill.skill, act, "AVOUPCircle", lifeTime - count * period);
