...
namespace SagaMap.Skill.SkillDefinations.Machinery
{
    ...
    public class RobotAtkUp : ISkill
    {
        ...
        void StartEventHandler(Actor actor, DefaultPassiveSkill skill)
        {
            ...
            //最大攻擊
            int max_atk1_add = (int)(actor.Status.max_atk_ori  * (0.08f + 0.02f * level));
            ...
            //最大攻擊
            int max_atk2_add = (int)(actor.Status.max_atk_ori * (0.08f + 0.02f * level));
            ...
            //最大攻擊
            int max_atk3_add = (int)(actor.Status.max_atk_ori * (0.08f + 0.02f * level));
            ...
            //最小攻擊
            int min_atk1_add = (int)(actor.Status.min_atk_ori  * (0.08f + 0.02f * level));
            ...
            //最小攻擊
            int min_atk2_add = (int)(actor.Status.min_atk_ori * (0.08f + 0.02f * level));
            ...
            //最小攻擊
            int min_atk3_add = (int)(actor.Status.min_atk_ori * (0.08f + 0.02f * level));
            ...
            //最大魔攻
            int max_matk_add = (int)(actor.Status.max_matk * (0.08f + 0.02f * level));
            ...
            //最小魔攻
            int min_matk_add = (int)(actor.Status.min_matk * (0.08f + 0.02f * level));
