...
namespace SagaMap.Skill.Additions.Global
{
    public class Stone : DefaultBuff 
    {
        public Stone(SagaDB.Skill.Skill skill, Actor actor, int lifetime)
            : base(skill, actor, "Stone", (int)(lifetime * (1f - actor.AbnormalStatus[SagaLib.AbnormalStatus.Stone] / 100 - actor.Status.Tenacity)), 100)
        {
        ...
        void StartEvent(Actor actor, DefaultBuff skill)
        {
            ...
            skill.Variable.Add("StoneFrosenElement", 100);
