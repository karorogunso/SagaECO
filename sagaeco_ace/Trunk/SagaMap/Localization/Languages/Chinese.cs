...
namespace SagaMap.Localization.Languages
{
    public class Chinese : Strings
    {
        public Chinese()
        {
            ...
            this.ATCOMMAND_ITEM_IDSEARCH = "用法: !idsearch 物品名字(不一定要完全) 最多显示10条";
            ...
            this.GET_EXP = "得到基本经验值 {0}  职业经验值 {1}";
            this.ATCOMMAND_ONLINE_PLAYER_INFO = "当前在线玩家: ";

            this.NPC_EventID_NotFound = "嘘!!$R想事情呢!$R$R$R(Event not found. Eventid={0})";
            this.NPC_EventID_NotFound_Msg = "NPC";
            ...
            this.ITEM_UNIDENTIFIED_BODYSUIT = "全身套装";
            this.ITEM_UNIDENTIFIED_FACEBODYSUIT = "制式套装";
            this.ITEM_UNIDENTIFIED_BACKPACK = "背包";
            ...
            this.ITEM_UNIDENTIFIED_KNUCKLE = "关节";
            this.ITEM_UNIDENTIFIED_SHIELD = "盾牌";
            this.ITEM_UNIDENTIFIED_HAMMER = "铁鎚";
            this.ITEM_UNIDENTIFIED_AXE = "斧头";
            this.ITEM_UNIDENTIFIED_SPEAR = "枪";
            ...
            this.ITEM_UNIDENTIFIED_ROPE = "绳子";
            ...
            this.ITEM_UNIDENTIFIED_TREASURE_BOX = "宝物箱";
            ...
            this.DEATH_PENALTY = "由于死亡惩罚经验值降低了"; //那个死亡经验减少了的那个.
