    ...
    public class SSMG_SKILL_ACTIVE : Packet
    {
        ...
        public void SetHP(List<int> hp)
        {
            ...
            if (Configuration.Instance.Version >= SagaLib.Version.Saga9_2)
            {
                ...
                for (int i = 0; i < combo; i++)
                {
                    this.PutInt(hp[i], (ushort)(18 + combo * 4 + i * 4));
        ...
        public void SetMP(List<int> mp)
        {
            ...
            if (Configuration.Instance.Version >= SagaLib.Version.Saga9_2)
            {
                ...
                for (int i = 0; i < combo; i++)
                {
                    this.PutInt(mp[i], (ushort)(19 + combo * 4 + combo * 8 + i * 4));
        ...
        public void SetSP(List<int> sp)
        {
            ...
            if (Configuration.Instance.Version >= SagaLib.Version.Saga9_2)
            {
                ...
                for (int i = 0; i < combo; i++)
                {
                    this.PutInt(sp[i], (ushort)(20 + combo * 4 + combo * 16 + i * 4));
        ...
        public byte SkillLv
        {
            set
            {
                ...
                if (Configuration.Instance.Version >= SagaLib.Version.Saga9_2)
                    this.PutByte(value, (ushort)(21 + combo * 4 + combo * 24 + combo * 4));
            }
        }
    }
}
