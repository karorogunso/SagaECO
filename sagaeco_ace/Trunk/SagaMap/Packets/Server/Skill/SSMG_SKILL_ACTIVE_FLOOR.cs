    ...
    public class SSMG_SKILL_ACTIVE_FLOOR : Packet
    {
        ...
        public void SetHP(List<int> hp)
        {
            ...
            for (int i = 0; i < combo; i++)
            {
                ...
                this.PutInt(hp[i], (ushort)((this.set + 12) + combo * 4 + combo + i * 8));
            }
        }
        ...
        public void SetMP(List<int> mp)
        {
            ...
            for (int i = 0; i < combo; i++)
            {
                ...
                this.PutInt(mp[i], (ushort)((this.set + 13) + combo * 4 + combo + combo * 8 + i * 8));
            }
        }
        ...
        public void SetSP(List<int> sp)
        {
            ...
            for (int i = 0; i < combo; i++)
            {
                ...
                this.PutInt(sp[i], (ushort)((this.set + 14) + combo * 4 + combo + combo * 16 + i * 8));
            }
        }
