...
namespace SagaLogin
{
    public class Configuration : Singleton<Configuration>
    {
        ...
        private bool allowMulticonnection = true;
        ...
        public bool AllowMultiConnection { get { return allowMulticonnection; } set { allowMulticonnection = value; } }
                ...
                foreach (object j in list)
                {
                    ...
                    switch (i.Name.ToLower())
                    {
                        ...
                        case "startstatus":
                            ...
                            break;
                        case "allowmulticonnect":
                            this.allowMulticonnection = bool.Parse(i.InnerText);
                            break;
                        case "startitem":
