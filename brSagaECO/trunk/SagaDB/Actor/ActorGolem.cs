...
namespace SagaDB.Actor
{
    ...
    public class ActorGolem : ActorMob
    {
        ...
        /// 石像收购金额上限
        /// </summary>
        public long BuyLimit { get { return this.buyLimit; } set { this.buyLimit = value; } }

        Dictionary<uint, GolemShopItem> sellShop = new Dictionary<uint, GolemShopItem>();
        /// <summary>
        /// 石像贩卖的道具
        /// </summary>
        public Dictionary<uint, GolemShopItem> SellShop { get { return this.sellShop; } }
        ...
        /// 石像收购的道具
        /// </summary>
        public Dictionary<uint, GolemShopItem> BuyShop { get { return this.buyShop; } }
