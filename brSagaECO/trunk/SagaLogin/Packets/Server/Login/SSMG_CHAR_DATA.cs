...
namespace SagaLogin.Packets.Server
{
    public class SSMG_CHAR_DATA : Packet
    {
        ...
        /*private void SetUnknown2(byte unknown, ushort index)
        {
            if (Configuration.Instance.Version >= SagaLib.Version.Saga11)
            {
                ushort offset = (ushort)(this.GetDataOffset() + 48);
                this.PutByte(4, offset);
        ...
        public List<ActorPC> Chars
        {
            set
            {
                ...
                for (int i = 0; i < count; i++)
                {
                    ...
                    //this.SetUnknown2(BitConverter.GetBytes(pc.Rebirth)[0], (ushort)i);
