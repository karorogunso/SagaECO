    ...
    public partial class MapClient
    {
        public void OnPossessionRequest(Packets.Client.CSMG_POSSESSION_REQUEST p)
        {
            ...
            if (result >= 0)
            {
                ...
                Tasks.PC.Possession task = new SagaMap.Tasks.PC.Possession(this, targetPC, pos, p.Comment, reduce);
        ...
        int TestPossesionPosition(Actor target, PossessionPosition pos)
        {
            Item item = null;
        ...
        public void OnPossessionCatalogOpen(Packets.Client.CSMG_POSSESSION_CATALOG_OPEN p)
        {
