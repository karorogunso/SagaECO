    ...
    public partial class MapClient
    {
        ...
        public void OnQuestDetailRequest(Packets.Client.CSMG_QUEST_DETAIL_REQUEST p)
        {
            if (QuestFactory.Instance.Items.ContainsKey(p.QuestID))
            {
                ...
                if (quest.DungeonID != 0)
                    p2.SetDetail(quest.QuestType, quest.Name, map1, map2, map3, name1, name2, name3, Dungeon.DungeonFactory.Instance.Items[quest.DungeonID].StartMap, quest.MapID2, quest.MapID3, quest.ObjectID1, quest.ObjectID2, quest.ObjectID3, (uint)quest.Count1, (uint)quest.Count2, (uint)quest.Count3, quest.TimeLimit, 0);
                else
        ...
        public void SendQuestInfo()
        {
            ...
            if (quest.Detail.DungeonID != 0)
                p2.SetDetail(quest.QuestType, quest.Name, map1, map2, map3, name1, name2, name3, quest.Status, Dungeon.DungeonFactory.Instance.Items[quest.Detail.DungeonID].StartMap, quest.Detail.MapID2, quest.Detail.MapID3, quest.Detail.ObjectID1, quest.Detail.ObjectID2, quest.Detail.ObjectID3, (uint)quest.Detail.Count1, (uint)quest.Detail.Count2, (uint)quest.Detail.Count3, quest.Detail.TimeLimit, 0);
            else
