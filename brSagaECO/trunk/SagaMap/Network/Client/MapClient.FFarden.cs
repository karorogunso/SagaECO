    ...
    public partial class MapClient
    {
        ...
        public void OnFFardenJoin(uint ringid)
        {
            ...
            if (ring.FFarden.MapID == 0)
            {
                ...
                ring.FFarden.MapID = MapManager.Instance.CreateMapInstance(ring, 90000000, this.Character.MapID, Global.PosX16to8(this.Character.X, map.Width), Global.PosY16to8(this.Character.Y, map.Height), false);
        ...
        {
            if (this.Character.MapID == 90000999)
            {
        ...
        {
            if (this.Character.MapID == 90000999 || this.Character.MapID == 91000999)
            {
