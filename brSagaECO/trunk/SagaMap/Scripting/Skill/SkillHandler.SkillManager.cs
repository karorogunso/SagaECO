...
namespace SagaMap.Skill
{
    ...
    {
        Dictionary<uint, ISkill> skillHandlers = new Dictionary<uint, ISkill>();

        public void Init()
        {
            skillHandlers.Add(9501, new SkillDefinations.c1skill.YumemiTest());
            #region c-1 new skill
            skillHandlers.Add(8900, new SkillDefinations.C1skill.ShadowBlast());
            skillHandlers.Add(610, new SkillDefinations.C1skill.MagicCri());
            skillHandlers.Add(611, new SkillDefinations.C1skill.SakuraSword());
            skillHandlers.Add(612, new SkillDefinations.C1skill.BlackFace());
            skillHandlers.Add(613, new SkillDefinations.C1skill.Tenacity());
            skillHandlers.Add(614, new SkillDefinations.C1skill.ShieldBlock());
            skillHandlers.Add(615, new SkillDefinations.C1skill.HoldingTheSpear());
            skillHandlers.Add(616, new SkillDefinations.C1skill.HotBlade());
            skillHandlers.Add(617, new SkillDefinations.C1skill.CriUP());
            skillHandlers.Add(618, new SkillDefinations.C1skill.ASSASINS());
            skillHandlers.Add(2183, new SkillDefinations.C1skill.Vajar());
            skillHandlers.Add(2187, new SkillDefinations.C1skill.MagicSword());
            #endregion
            #region Royaldealer
            ...
            skillHandlers.Add(402, new SkillDefinations.Command.HumAvoUp());
            ...
            skillHandlers.Add(2144, new SkillDefinations.Archer.FireArrow());
            skillHandlers.Add(2145, new SkillDefinations.Archer.WaterArrow());
            skillHandlers.Add(2146, new SkillDefinations.Archer.EarthArrow());
            skillHandlers.Add(2147, new SkillDefinations.Archer.WindArrow());
