    ...
    public class A_T_PJoint : ISkill
    {
        ...
        public class PJointBuff : DefaultBuff
        {
            ...
            void StartEvent(Actor actor, DefaultBuff skill)
            {
                ...
                //最大攻擊
                int max_atk1_add = (int)(sActor.Status.max_atk_ori  * factor);
                ...
                //最大攻擊
                int max_atk2_add = (int)(sActor.Status.max_atk_ori * factor);
                ...
                //最大攻擊
                int max_atk3_add = (int)(sActor.Status.max_atk_ori * factor);
                ...
                //最小攻擊
                int min_atk1_add = (int)(sActor.Status.min_atk_ori  * factor);
                ...
                //最小攻擊
                int min_atk2_add = (int)(sActor.Status.min_atk_ori * factor);
                ...
                //最小攻擊
                int min_atk3_add = (int)(sActor.Status.min_atk_ori * factor);
                ...
                //最小魔攻
                int min_matk_add = (int)(sActor.Status.min_matk * factor);
                ...
                //最大魔攻
                int max_matk_add = (int)(sActor.Status.max_matk * factor);
