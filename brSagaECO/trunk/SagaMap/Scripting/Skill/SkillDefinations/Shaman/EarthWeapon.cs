...
{
    public class EarthWeapon:ISkill
    {
        ...
        public void Proc(Actor sActor, Actor dActor, SkillArg args, byte level)
        {
            ...
            DefaultBuff skill = new DefaultBuff(args.skill, dActor, "EarthWeapon", 50000);
        ...
        void StartEventHandler(Actor actor, DefaultBuff skill)
        {
            ...
            actor.AttackElements[SagaLib.Elements.Earth] += atk;

            actor.Buff.武器の土属性上昇 = true;
        ...
        void EndEventHandler(Actor actor, DefaultBuff skill)
        {
            ...
            actor.AttackElements[SagaLib.Elements.Earth] -= value;
            actor.Buff.武器の土属性上昇 = false;
            Manager.MapManager.Instance.GetMap(actor.MapID).SendEventToAllActorsWhoCanSeeActor(Map.EVENT_TYPE.BUFF_CHANGE, null, actor, true);
        }
        #endregion
    }
