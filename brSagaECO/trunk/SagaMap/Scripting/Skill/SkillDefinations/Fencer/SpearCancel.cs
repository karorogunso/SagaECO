...
namespace SagaMap.Skill.SkillDefinations.Fencer
{
    ...
    public class SpearCancel:ISkill
    {
        ...
        public void Proc(Actor sActor, Actor dActor, SkillArg args, byte level)
        {
            ...
            {
                int life = 20000;
                DefaultBuff skill = new DefaultBuff(args.skill, realdActor, "SpearCancel", life);
        ...
        {
            actor.Status.aspd_skill_perc += (float)(1.2f + 0.3 * skill.skill.Level);
        ...
        {
            float raspd_skill_perc_restore = (float)(1.2f + 0.3 * skill.skill.Level);
