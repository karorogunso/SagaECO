...
namespace SagaMap.Skill.SkillDefinations.Global
{
    ...
    public class Soul : ISkill
    {
        ...
        void SetupSkill(Actor actor, DefaultPassiveSkill skill)
        {
            ...
            {
                max_atk_ori_add = (int)(actor.Status.max_atk_ori * (0.14));
                min_atk_ori_add = (int)(actor.Status.min_atk_ori  * (0.14));
                max_atk_ori_add = (int)(actor.Status.max_atk_ori * (0.14));
                min_atk_ori_add = (int)(actor.Status.min_atk_ori * (0.14));
                max_atk_ori_add = (int)(actor.Status.max_atk_ori * (0.14));
                min_atk_ori_add = (int)(actor.Status.min_atk_ori * (0.14));
            ...
            {
                max_atk_ori_add = (int)(actor.Status.max_atk_ori * (0.07));
                min_atk_ori_add = (int)(actor.Status.min_atk_ori * (0.07));
                max_matk_add = (int)(actor.Status.max_matk_ori * 0.07);
                min_matk_add = (int)(actor.Status.min_matk_ori * 0.05);
            ...
            {
                max_atk_ori_add = (int)(actor.Status.max_atk_ori * (0.08));
                min_atk_ori_add = (int)(actor.Status.min_atk_ori * (0.08));
                max_matk_add = (int)(actor.Status.max_matk_ori * 0.08);
                min_matk_add = (int)(actor.Status.min_matk_ori * 0.08);
            ...
            {
                max_atk_ori_add = (int)(actor.Status.max_atk_ori  * (0.05));
                min_atk_ori_add = (int)(actor.Status.min_atk_ori  * (0.05));
                max_matk_add = (int)(actor.Status.max_matk_ori * 0.05);
                min_matk_add = (int)(actor.Status.min_matk_ori * 0.05);
