...
namespace SagaMap.Skill.SkillDefinations.Monster
{
    ...
    public class MobCircleAtkup : ISkill
    {
        ...
        void StartEventHandler(Actor actor, DefaultBuff skill)
        {
            ...
            //最大攻擊
            int max_atk1_add = (int)(actor.Status.max_atk_ori  * 0.02f);
            ...
            //最大攻擊
            int max_atk2_add = (int)(actor.Status.max_atk_ori * 0.02f);
            ...
            //最大攻擊
            int max_atk3_add = (int)(actor.Status.max_atk_ori * 0.02f);
