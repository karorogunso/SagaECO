...
namespace SagaMap.Skill.SkillDefinations.ForceMaster
{
    public class CSPDCommunion : ISkill
    {
        ...
        void StartEventHandler(Actor actor, DefaultBuff skill)
        {
            ...
            if (skill.Variable.ContainsKey("CSPDCommunion"))
                skill.Variable.Remove("CSPDCommunion");
            skill.Variable.Add("CSPDCommunion", cspd_add);
        ...
        {
            actor.Status.cspd_skill -= (short)skill.Variable["CSPDCommunion"];
