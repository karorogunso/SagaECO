...
namespace SagaMap.Skill.SkillDefinations.Bard
{
    ...
    public class Fusion : ISkill
    {
        ...
        public void Proc(Actor sActor, Actor dActor, SkillArg args, byte level)
        {
            ...
            //註冊施放者的Buff
            DefaultBuff skill = new DefaultBuff(args.skill, sActor, "Fusion_Caster", (30 + level * 30) * 1000);
                    ...
                    if (count < countMax)
                    {
                        ...
                        foreach (Actor act in actors)
                        {
                            if (act.type == ActorType.PC || act.type == ActorType.PET)
                            {
                                ...
                                {
                                    DefaultBuff skill2 = new DefaultBuff(skill.skill, act, "Fusion", lifeTime - count * period);
