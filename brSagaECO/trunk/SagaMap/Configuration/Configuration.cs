...
namespace SagaMap
{
    ...
    public class Configuration : Singleton<Configuration>
    {
        ...
        public float CalcCEXPRateForPC(ActorPC pc)
        {
            float rate = CalcEXPRateForPC(pc);
            rate *= pc.CEXPGainRate;
            return rate;
        }

        public float CalcJEXPRateForPC(ActorPC pc)
        {
            float rate = CalcEXPRateForPC(pc);
            rate *= pc.JEXPGainRate;
            return rate;
        }
        ...
        public ushort BasePhysiceDef { get { return this.basePhysiceDef; } set {this.basePhysiceDef = value;} }
                ...
                foreach (object j in list)
                {
                    ...
                    switch (i.Name.ToLower())
                    {
                        ...
                        case "stampdroprate":
                            ...
                            break;
                        case "specialdroprate":
                            this.specialDropRate = int.Parse(i.InnerText);
                            break;
                        case "itemfusionrate":
                        ...
                        case "mobamount":
                            ...
                            break;
                        case "basephysicdef":
                            this.basePhysiceDef = ushort.Parse(i.InnerText);
                            break;
                        case "basemagicdef":
...
//#else
        void InitDat(string path)
        {
            ...
            if (magic == 0x12345678)
            {
                ...
                this.vshopclosed = br.ReadBoolean();
