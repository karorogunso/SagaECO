...
namespace SagaScript
{
    public abstract class 道具箱 : Event
    {
        ...
        public override void OnEvent(ActorPC pc)
        {
            ...
            string[] badge = new string[] {"埃米爾徽章", "銅徽章", "銀徽章", "金徽章" };
            ...
            Say(pc, 0, 65535, "會有什麼厲害的道具呢?$R;" +
                              "真是叫人期待的道具箱!$R;", " ");

            switch (Select(pc, "要放什麼徽章?", "", badge_01, badge_02, "沒興趣"))
            {
                case 1:
                    //尚未實裝道具箱功能
                    Say(pc, 0, 65535, "目前尚未實裝$R;", " ");

                    Say(pc, 0, 65535, "沒有銅徽章!$R;", " ");
                    break;
