...
//所在地圖:上城北邊吊橋(10023400) NPC基本信息:上城北門守衛(10000033) X:126 Y:33
namespace SagaScript.M10023400
{
    public class S10000033 : Event
    {
        public S10000033()
        {
            this.EventID = 10000033;
        }
        ...
        public override void OnEvent(ActorPC pc)
        {
            ...
            if (CountItem(pc, 10042801) >= 1)
            {
                if (pc.Gold < 100)
                {
                    ...
                    Warp(pc, 10023000, 128, 37);
                    return;
                }
                switch (Select(pc, "欢迎来到阿高普路斯唷!", "", "进入上城", "辛苦了", "不进去"))
                {
                    case 1:
                        if (pc.PossesionedActors.Count != 0)
                        {
            ...
            if (Knights_mask.Test(Knights.告知無法加入北軍) &&
