...
namespace SagaScript.M30100000
{
    public class S11000037 : Event
    {
        ...
        public override void OnEvent(ActorPC pc)
        {
            ...
            if (pc.Fame < 1)
            {
                Say(pc, 131, "我就是$R奧克魯尼亞混城騎士團東軍長官$R;" +
                    "我們軍隊是．．$R;" +
                    "$P…??$R;" +
                    "$P您到這個城市沒有多久吧？$R;" +
                    "$R對吧？$R逃不過我的眼睛的啦$R;" +
            ...
            {
                Say(pc, 131, "年輕人！$R我是奧克魯尼亞混城騎士團東軍長官$R;" +
                    "布魯諾$R;" +
                    "我們騎士團需要您這樣的年輕人！$R;");
                switch (Select(pc, "怎麼辦呢？", "", "加入東軍", "聽一聽關於騎士團的故事", "不聽"))
                {
                    case 1:
                        switch (Select(pc, "真的想加入東軍嗎？", "", "加入", "不加入", "再想一想"))
                        {
                            case 1:
                                ...
                                switch (Select(pc, "想要簽名嗎？", "", "簽名", "還是放棄"))
                                {
                                    case 1:
                                        Say(pc, 131, "嗯…很好！$R;" +
                                            "$R現在開始$R您是我們奧克魯尼亞混城騎士團東軍$R見習軍團員啦$R;" +
                                            "$P先收下這個吧$R;");
                                        GiveItem(pc, 10041300, 1);
                                        PlaySound(pc, 4006, false, 100, 50);
                                        Say(pc, 0, 131, "得到$R『帕斯特騎士團證』$R;");
                                        Knights_mask.SetValue(Knights.加入東軍騎士團, true);
                                        Say(pc, 131, "這就是您作為$R混城騎士團東軍團員的證據。$R;" +
                                            "$R同時是帕斯特的公民權，$R好好保管吧$R;" +
                                            "$P還有這是阿高普路斯市的通行證。$R;");
                    ...
                    case 2:
                        Say(pc, 131, "奧克魯尼亞混城騎士團$R是為了守護自由之都：阿高普路斯市$R;" +
                            "$R由世界的4大國家派遣的聯合軍，$R;" +
                            "$P東門由我們$R帕斯特共和國管轄的$R;" +
                            "$R混城騎士團除了我們，$R還有西軍、南軍、北軍一共4個軍隊$R;" +
                            "最強的當然是我們東軍啦。$R;" +
                            "$P而且入團還有特權！$R入團者可以得到帕斯特國公民權唷。$R;" +
                            "有了公民權可以在帕斯特自由出入唷$R帕斯特的東西也很好吃的！$R;" +
                            "那麼！加入我們東軍，怎麼樣呢？$R;");
