            ...
            if (CountItem(pc, 50012300) >= 1)
            {
                ...
                */
                Say(pc, 131, "啦啦啦$R;" +
                    ...
                    "什麽都可以染色的帥阿姨！$R;" +
                    "$R『迷你裙』花500金幣，染色如何？$R;");
                switch (Select(pc, "花500金幣染色？", "", "染色！", "想挑顔色！", "不想染色！"))
                {
                    case 1:
                        /*
                    ...
                    case 2:
                        ...
                        */
                        if (pc.Gold > 999)
                        {
                            Say(pc, 131, "挑顔色的話$R;" +
                                "拿1000金幣過來吧？$R;");
                            switch (Select(pc, "花1000金幣染色嗎？", "", "加金黃色條紋！", "染淺棕色！", "染灰色方格紋！", "染綠色方格紋！", "染藍色方格紋！", "染淺綠色！", "染深綠色！", "染白色！", "染薄荷綠色！", "加白色條紋！", "染深紅色！", "不染色"))
                            {
                                case 1:
                                    TakeItem(pc, 50012300, 1);
                                    GiveItem(pc, 50012350, 1);
