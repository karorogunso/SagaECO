...
//所在地圖:東部平原初心者學校(30091001) NPC基本信息:初階冒險者(11000991) X:8 Y:9
namespace SagaScript.M30091001
{
    public class S11000991 : Event
    {
        public S11000991()
        {
            this.EventID = 11000991;
        }
        ...
        public override void OnEvent(ActorPC pc)
        {
            ...
            Say(pc, 11000991, 0, "啊，您好!$R;", "初階冒險者");
        }
