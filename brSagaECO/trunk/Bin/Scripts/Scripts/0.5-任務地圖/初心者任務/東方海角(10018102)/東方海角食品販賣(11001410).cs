...
namespace SagaScript.M10018102
{
    public class S11001410 : Event
    {
        ...
        public override void OnEvent(ActorPC pc)
        {
            ...
            {
                case 1:
                    Say(pc, 11001410, 131, "這一次將簡單的說明。$R;" +
                                           "$P想賣道具時，選擇「賣東西」。$R;" +
                                           "$R就會顯示交易視窗，$R;" +
                                           "把想賣的道具移到右邊，$R;" +
                                           "點擊「售賣」。$R;" +
        ...
        {
            Say(pc, 11001410, 131, "還沒有聽過埃米爾的講解吧?$R;" +
                                   "$R先聽完後再來吧!$R;", "東方海角食品販賣");
        }
                ...
                !Beginner_01_mask.Test(Beginner_01.販賣巧克力完成))
            {
                ...
                switch (Select(pc, "聽一聽買賣物品的方法，如何?", "", "我要聽! 我要聽!", "不用了"))
                {
                    case 1:
                        ...
                        Say(pc, 11001410, 131, "先教您賣道具的方法吧!$R;" +
                                               "$R試試賣一下我給您的『巧克力』吧!$R;" +
                                               "$P把想賣的道具移到右邊視窗，$R;" +
                                               "再點一下「賣」鍵。$R;" +
                                               "$R很簡單吧?$R;", "東方海角食品販賣");
