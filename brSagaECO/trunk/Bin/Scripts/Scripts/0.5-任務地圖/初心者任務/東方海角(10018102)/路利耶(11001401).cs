...
namespace SagaScript.M10018102
{
    public class S11001401 : Event
    {
        ...
        public override void OnEvent(ActorPC pc)
        {
            ...
            while (selection != 5)
            {
                switch (selection)
                {
                    ...
                    case 2:
                        Say(pc, 11001401, 131, "現在說明遊戲裡的視點…$R;" +
                                               "及照相機的操作方法吧!$R;" +
                                               "$P任意在畫面上$R;" +
                                               "點擊右鍵一邊拖一邊移動試試看吧!$R;" +
                                               "$P…$R;" +
                    ...
                    case 3:
                        Say(pc, 11001401, 131, "想把遊戲畫面拍下時，$R;" +
                    ...
                    case 4:
                        Say(pc, 11001401, 131, "在「環境設定」視窗$R;" +
                                               "可以調整遊戲的顯示或聲音。$R;" +
                                               "$P螢幕右上方有按鍵，$R;" +
                                               "點擊從右數到左第三個鍵，$R;" +
                                               "會顯示「系統」視窗。$R;" +
        ...
        {
            Say(pc, 11001401, 131, "埃米爾的話都聽過了嗎?$R;" +
                                   "最好先聽聽埃米爾的情報唷!", "路利耶");
        }  
    }
}
