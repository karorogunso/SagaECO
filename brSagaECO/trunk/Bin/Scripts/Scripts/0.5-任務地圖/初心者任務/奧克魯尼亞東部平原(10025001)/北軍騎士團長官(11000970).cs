...
namespace SagaScript.M10025001
{
    public class S11000970 : Event
    {
        ...
        public override void OnEvent(ActorPC pc)
        {
            ...
            Say(pc, 11000970, 131, "對我們北軍有興趣嗎?$R;", "北軍騎士團長官");

            switch (Select(pc, "要問嗎?", "", "諾頓島是?", "… 不用了"))
            {
                case 1:
                    Say(pc, 11000970, 131, "是位於奧克魯尼亞大陸北邊，$R;" +
                                           "被冰山圍繞的島嶼。$R;" +
                                           "$P魔法非常發達，$R;" +
                                           "城市裡的浪漫風景一定要看啊!$R;" +
                                           "$P聽說在諾頓，有很多獨自冒險的人。$R;" +
                ...
                case 2:
                    Say(pc, 11000970, 131, "這樣呀…$R;" +
                                           "$R如果想加入北軍的話，$R;" +
                                           "請隨時來到城市北邊，$R;" +
                                           "北軍騎士團的長官室吧!$R;" +
                                           "$R在城市北邊左右側，$R;" +
                                           "華麗的藍色建築物就是了。$R;", "北軍騎士團長官");
                    break;
            }
        }
        ...
        void 與騎士團長官們進行第一次對話(ActorPC pc)
        {
            ...
            Say(pc, 11000970, 131, "歡迎來到阿高普路斯市唷!$R;", "北軍騎士團長官");
