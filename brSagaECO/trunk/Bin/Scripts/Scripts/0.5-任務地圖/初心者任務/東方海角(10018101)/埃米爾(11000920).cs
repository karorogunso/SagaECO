...
namespace SagaScript.M10018101
{
    public class S11000920 : Event
    {
        ...
        public override void OnEvent(ActorPC pc)
        {
            ...
            {
                Say(pc, 11000920, 131, "什麼，再說明一下?$R;", "埃米爾");
            }
            ...
            while (selection != 5)
            {
                ...
                {
                    case 1:
                        Say(pc, 11000920, 131, "想跟村裡的人打招呼，$R;" +
                                               "或攻擊敵人的時候，$R;" +
                                               "對目標點擊滑鼠左鍵就可以囉。$R;" +
                                               "$P…看您跟我打招呼了，$R;" +
                                               "應該已經知道了吧?$R;" +
                    ...
                    case 2:
                        Say(pc, 11000920, 131, "移動時，在移動目標上點擊左鍵即可。$R;" +
                                               "$R如果長時間持續點擊，$R;" +
                                               "就會自動跟著滑鼠移動方向移動。$R;" +
                                               "$P人太多的時候操作困難。$R;" +
                                               "$R這時用鍵盤的方向鍵移動，$R;" +
                    ...
                    case 4:
                        Say(pc, 11000920, 131, "想移動到下一幅地圖時，$R;" +
                                               "看到藍色光柱了嗎?$R;" +
                                               "這是「傳送點」，$R;" +
                                               "踩到它就會進入下一個地圖唷!$R;" +
                                               "$P同樣的，進入店裡時踩傳送點即可。$R;" +
