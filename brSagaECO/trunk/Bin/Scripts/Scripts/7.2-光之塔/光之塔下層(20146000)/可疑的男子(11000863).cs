...
namespace SagaScript.M20146000
{
    public class S11000863 : Event
    {
        ...
        void 渦輪(ActorPC pc)
        {
            switch (Select(pc, "怎麼辦呢？", "", "饒您一次", "不行！您得有心理准備！"))
            {
                case 1:
                    Say(pc, 131, "哎呀…$R;" +
                        "太感謝了$R;" +
                    ...
                    {
                        Say(pc, 131, "『ターボエンジン』重いですけど$R;" +
                            "もっ、もてますか？$R;");
                        switch (Select(pc, "持てる？", "", "持てない", "余裕です！"))
                        {
                            case 1:
                                Say(pc, 131, "じゃ、じゃあ、かえせませんね！$R;");
                                break;
                            case 2:
                                //_Xb42 = true;
                                GiveItem(pc, 10027750, 1);
                                PlaySound(pc, 2040, false, 100, 50);
                                Say(pc, 131, "得到『渦輪引擎』$R;");
                                break;
                        }
                        return;
                    }
                    PlaySound(pc, 2041, false, 100, 50);
                    Say(pc, 131, "東西太多了，不能接受呀$R;");
                    break;
                case 2:
                    Say(pc, 131, "饒了我吧…$R;" +
                        "$R不要好嗎…$R;" +
