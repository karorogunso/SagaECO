...
using SagaDB.Quests;
//所在地圖:北方中央山脈(10050001) NPC基本信息:出張任務受付(11001987) X:221 Y:139
namespace SagaScript.M10050001
{
    public class S11001987 : Event
    {
        public S11001987()
        {
            this.EventID = 11001987;
        ...
        {
            Say(pc, 11001988, 131, "雖然我說了喜歡清涼的地方......$R;" +
                "$R但這裡也太冷了吧!!(抖抖$R;", "咖啡館店員");
