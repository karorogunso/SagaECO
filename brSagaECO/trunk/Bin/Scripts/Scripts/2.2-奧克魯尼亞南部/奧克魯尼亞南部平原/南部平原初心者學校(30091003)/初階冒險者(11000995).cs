...
//所在地圖:南部平原初心者學校(30091003) NPC基本信息:初階冒險者(11000995) X:8 Y:9
namespace SagaScript.M30091003
{
    public class S11000995 : Event
    {
        public S11000995()
        {
            this.EventID = 11000995;
        }
        ...
        public override void OnEvent(ActorPC pc)
        {
            ...
            Say(pc, 11000995, 0, "啊，您好!$R;", "初階冒險者");
        }
