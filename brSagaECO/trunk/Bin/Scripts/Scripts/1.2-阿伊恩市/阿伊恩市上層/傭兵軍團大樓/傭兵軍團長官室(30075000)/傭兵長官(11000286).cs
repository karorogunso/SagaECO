    ...
    public class S11000286 : Event
    {
        ...
        public override void OnEvent(ActorPC pc)
        {
            ...
            */
            ...
            Say(pc, 131, "您看起來比較有錢啊$R;" +
                "我們是傭兵軍團。$R;" +
                "只要給錢，我們什麼都可以做呢$R;");
            switch (Select(pc, "僱用傭兵嗎？", "", "好", "不要"))
            {
                case 1:
                    Say(pc, 131, "講重點，給多少？$R;");
                    int count = int.Parse(InputBox(pc, "請輸入金額", InputType.ItemCode));
                    int a = pc.Level * 3000;
                    if (count < a )
                    {
                        Say(pc, 131, "別開玩笑吧！$R;" +
