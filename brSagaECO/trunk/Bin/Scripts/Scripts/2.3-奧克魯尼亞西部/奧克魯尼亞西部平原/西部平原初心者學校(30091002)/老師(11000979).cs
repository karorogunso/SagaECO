    ...
    public class S11000979 : Event
    {
        ...
        public override void OnEvent(ActorPC pc)
        {
            ...
            while (selection != 9)
            {
                switch (selection)
                {
                    ...
                    case 2:
                        Say(pc, 11000979, 131, "在進入「上城」的入口$R;" +
                                               "被警衛阻止了?$R;" +
                                               "$R您一定覺得很奇怪吧?$R;" +
                                               "「阿高普路斯市」是自由貿易城市，$R;" +
                                               "可為什麼無法自由的進出…$R;" +
                    ...
                    case 3:
                        Say(pc, 11000979, 131, "是說「奧克魯尼亞混城騎士團」吧?$R;" +
                                               "在「騎士團宮殿」那裡受到勸誘嗎?$R;" +
                                               "$R嗯…說到優點的話，$R;" +
                                               "應該說…$R;" +
                                               "可以自由出入軍隊所屬的國家吧?$R;" +
                    ...
                    case 4:
                        Say(pc, 11000979, 131, "如果還沒決定職業的話…$R;" +
                                               "$R開始的時候，$R;" +
                                               "還是選擇戰士系的$R;" +
                                               "「劍士」或「騎士」吧!$R;" +
                                               "比較容易熟悉適應環境。$R;", "老師");
                    ...
                    case 5:
                        Say(pc, 11000979, 131, "這麼快就完成3個「任務」啦?$R;" +
                                               "呵呵!$R;" +
                                               "$R先把在「阿高普路斯市」$R;" +
                                               "東、南、西、北平原的『木箱』打破吧!$R;" +
                                               "$P把箱子打破後，將得到『木箱』唷!$R;" +
                    ...
                    case 6:
                        Say(pc, 11000979, 131, "可能您還沒見過『木箱』吧?$R;" +
                                               "$R但是『寶物箱』和『集裝箱』裡面，$R;" +
                                               "同樣裝有各種道具的喔!$R;" +
                                               "$P拜託「道具精製師」幫忙的話，$R;" +
                                               "他會幫您打開箱子的。$R;" +
        ...
        void 問題頁(ActorPC pc)
        {
            ...
            while (selection != 6)
            {
                ...
                {
                    case 1:
                        Say(pc, 11000979, 131, "別客氣，安心的說吧!$R;" +
                                               "$P話雖如此，還是挺需要勇氣的吧?$R;" +
                                               "$P如果害怕跟人交談，$R;" +
                                               "我可以給您介紹一個功能喔!$R;" +
                                               "$R可以試試使用$R;" +
                    ...
                    case 2:
                        Say(pc, 11000979, 131, "想邀請對方加入隊伍的話，$R;" +
                                               "用滑鼠右鍵點擊對方，$R;" +
                                               "選擇「邀請加入隊伍」試試吧!$R;" +
                                               "$R對方就會顯示邀請加入的視窗，$R;" +
                                               "如果忽然邀請的話，會嚇著對方的。$R;" +
                    ...
                    case 3:
                        Say(pc, 11000979, 131, "好像聽到了廣播啊?$R;" +
                                               "$R「騎士團練習」$R;" +
                                               "簡單的說，$R;" +
                                               "就是玩家們分為東、南、西、北軍後，$R;" +
                                               "進行的模擬戰鬥。$R;" +
                    ...
                    case 4:
                        Say(pc, 11000979, 131, "嗯，寵物的種類雖然很多…$R;" +
                                               "$R但是，到「玩家商店」那裡買的話，$R;" +
                                               "是最簡單的。$R;" +
                                               "$P想在商店裡購買的話，$R;" +
                                               "可以去「東方海角」的「寵物店」。$R;" +
                    ...
                    case 5:
                        Say(pc, 11000979, 131, "聽說「阿高普路斯市」的「上城」$R;" +
                                               "有個分發活動木偶的女孩…$R;" +
                                               "$P好像叫…埃琳娜?$R;" +
                                               "聽說是個可愛的塔尼亞女孩，$R;" +
                                               "$R下次去看看吧!$R;", "老師");
        ...
        void 困難頁(ActorPC pc)
        {
            ...
            while (selection != 6)
            {
                switch (selection)
                {
                    ...
                    case 3:
                        Say(pc, 11000979, 131, "裝備得持久度降到0的話，$R;" +
                                               "圖示會變成半透明，就無法裝備了。$R;" +
                                               "$R那是道具「損壞」的意思。$R;" +
                                               "$P但是不代表，$R;" +
                                               "永遠不能使用那道具。$R;" +
                    ...
                    case 4:
                        Say(pc, 11000979, 131, "什麼…寵物的圖示$R;" +
                                               "要是變成半透明的話，$R;" +
                                               "就不能帶牠出去了?$R;" +
                                               "$R請放心吧，那個不是指寵物死了。$R;" +
                                               "$R只是「親密度」跌到0而已!$R;" +
