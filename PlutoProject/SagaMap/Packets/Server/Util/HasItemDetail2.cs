    ...
    public abstract class HasItemDetail2 : Packet
    {
        ...
        protected Item ItemDetail
        {
            set
            {
                ...
                this.PutShort((short)(value.BaseData.hp + value.HP + value.hp_refine));
                ...
                this.PutShort((short)(value.BaseData.atk1 + value.Atk1 + value.atkrate_refine));
                this.PutShort((short)(value.BaseData.atk2 + value.Atk2 + value.atkrate_refine));
                this.PutShort((short)(value.BaseData.atk3 + value.Atk3 + value.atkrate_refine));
                this.PutShort((short)(value.BaseData.matk + value.MAtk + value.matkrate_refine));
