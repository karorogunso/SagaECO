    ...
    public class Samba : ISkill
    {
        ...
        private class Activator : MultiRunTask
        {
                    ...
                    if (count < countMax)
                    {
                        ...
                        foreach (Actor act in actors)
                        {
                            if (act.type == ActorType.PC || act.type == ActorType.PET)
                            {
                                ...
                                {
                                    DefaultBuff skill2 = new DefaultBuff(skill.skill, act, "DefUpCircle", lifeTime - count * period, 200);
            ...
            void StartEventHandler(Actor actor, DefaultBuff skill)
            {
                ...
                short[] ldefs = new short[] { 0, 5, 7, 8, 9, 10 };
                short LDef = (short)ldefs[level];
                short RDef = (short)(10 * level);
                //左防
