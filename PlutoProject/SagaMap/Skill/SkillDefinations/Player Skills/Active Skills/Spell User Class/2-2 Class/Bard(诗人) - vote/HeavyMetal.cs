...
namespace SagaMap.Skill.SkillDefinations.Bard
{
    ...
    public class HeavyMetal : ISkill
    {
        ...
        public void Proc(Actor sActor, Actor dActor, SkillArg args, byte level)
        {
            ...
            //註冊施放者的Buff
            DefaultBuff skill = new DefaultBuff(args.skill, sActor, "HeavyMetal_Caster", 30000 + 30000 * level);
                    ...
                    if (count < countMax)
                    {
                        ...
                        foreach (Actor act in actors)
                        {
                            if (act.type == ActorType.PC || act.type == ActorType.PET)
                            {
                                ...
                                {
                                    DefaultBuff skill2 = new DefaultBuff(skill.skill, act, "HeavyMetal", lifeTime - count * period, 200);
