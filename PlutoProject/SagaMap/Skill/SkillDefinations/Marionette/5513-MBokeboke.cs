...
namespace SagaMap.Skill.SkillDefinations.Marionette
{
    ...
    public class MBokeboke : ISkill
    {
        ...
        void StartEventHandler(Actor actor, DefaultBuff skill)
        {
            ...
            //最大攻擊
            int max_atk2_add = -(int)(actor.Status.max_atk2 * 0.1f);
            ...
            //最大攻擊
            int max_atk3_add = -(int)(actor.Status.max_atk3 * 0.1f);
            ...
            //最小攻擊
            int min_atk1_add = -(int)(actor.Status.min_atk1 * 0.1f);
            ...
            //最小攻擊
            int min_atk2_add = -(int)(actor.Status.min_atk2 * 0.1f);
            ...
            //最小攻擊
            int min_atk3_add = -(int)(actor.Status.min_atk3 * 0.1f);
            ...
            //最大魔攻
            int max_matk_add = -(int)(actor.Status.max_matk * 0.1f);
            ...
            //最小魔攻
            int min_matk_add = -(int)(actor.Status.min_matk * 0.1f);
