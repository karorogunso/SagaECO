...
namespace SagaMap.Skill.Additions.Global
{
    public class Medicine3 : DefaultBuff
    {
        public Medicine3(SagaDB.Skill.Skill skill, Actor actor, int lifetime)
            : base(skill, actor, "Medicine3", lifetime, (int)(2000.0f * (1.0f - (float)((float)Math.Max(actor.Status.cspd, actor.Status.aspd) / 1000f))))
        {
        ...
        void EndEvent(Actor actor, DefaultBuff skill)
        {
            ...
            uint recover = (uint)skill.Variable["MedicineHealing3"];
