...
namespace SagaMap.Skill
{
    public partial class SkillHandler : Singleton<SkillHandler>
    {
        ...
        public void Init()
        {
            ...
            skillHandlers.Add(4026, new SkillDefinations.Global.A_T_PJoint());
            ...
            skillHandlers.Add(2070, new SkillDefinations.Global.SpeedUpSkill());
            ...
            #region Mob
            skillHandlers.Add(7843, new SkillDefinations.Global.ElementShield(Elements.Fire, true));
            skillHandlers.Add(7169, new SkillDefinations.Global.StarLove());
            ...
            skillHandlers.Add(7528, new SkillDefinations.Monster.MobStormSword());
            ...
            skillHandlers.Add(5520, new SkillDefinations.Global.DarkSun());
            ...
            skillHandlers.Add(2116, new SkillDefinations.BladeMaster.StormSword());
            ...
            skillHandlers.Add(2396, new SkillDefinations.BountyHunter.SwordAssail());
            skillHandlers.Add(2397, new SkillDefinations.BountyHunter.SwordAssailSEQ());
            ...
            skillHandlers.Add(2266, new SkillDefinations.Striker.BlastArrow());
            ...
            skillHandlers.Add(2431, new SkillDefinations.TreasureHunter.SonicWhipSEQ());
            ...
            #region 自定义技能
            skillHandlers.Add(4901, new SkillDefinations.SunFlowerAdditions.ModeChange());
            skillHandlers.Add(25000, new SkillDefinations.SunFlowerAdditions.PassiveStr());
            skillHandlers.Add(25001, new SkillDefinations.SunFlowerAdditions.PassiveAgi());
            skillHandlers.Add(25002, new SkillDefinations.SunFlowerAdditions.PassiveInt());
            skillHandlers.Add(25003, new SkillDefinations.SunFlowerAdditions.PassiveVit());
            skillHandlers.Add(25004, new SkillDefinations.SunFlowerAdditions.PassiveDex());
            skillHandlers.Add(25005, new SkillDefinations.SunFlowerAdditions.PassiveMag());
            skillHandlers.Add(27052, new SkillDefinations.SunFlowerAdditions.HolyLight());
            skillHandlers.Add(27053, new SkillDefinations.SunFlowerAdditions.KyrieEleison());
            skillHandlers.Add(27054, new SkillDefinations.SunFlowerAdditions.HighHeal());
            skillHandlers.Add(27055, new SkillDefinations.SunFlowerAdditions.Assumptio());
            skillHandlers.Add(27056, new SkillDefinations.SunFlowerAdditions.Judex());
            skillHandlers.Add(27057, new SkillDefinations.SunFlowerAdditions.Adoramus());
            skillHandlers.Add(27058, new SkillDefinations.SunFlowerAdditions.Oratio());
            skillHandlers.Add(27059, new SkillDefinations.SunFlowerAdditions.TurnUndead());
            skillHandlers.Add(27060, new SkillDefinations.SunFlowerAdditions.EquipChange());
            #endregion
