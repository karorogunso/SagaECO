...
{
    public class S11000589 : Event
    {
        public S11000589()
        {
            this.EventID = 11000589;
        }
        ...
        public override void OnEvent(ActorPC pc)
        {
            ...
            if (Job2X_12_mask.Test(Job2X_12.收集花束))
            {
                Say(pc, 11000589, 131, "出力100%!非常健康!$R;");
                Say(pc, 11000584, 131, "暂时避开过分的驾驶$R;" +
                    "$R在气管上如果有问题的话$R就过来看看状态吧$R;");
                return;
            }
            ...
            if (Job2X_12_mask.Test(Job2X_12.收集石油) && !Job2X_12_mask.Test(Job2X_12.給予石油))//_3A72 && !_3A77)
            {
                ...
                Say(pc, 11000584, 131, "!!$R不是「油」10份阿!!$R重新拿过来!$R;");
                return;
            }
