...
//所在地圖:北部平原初心者學校(30091004) NPC基本信息:老師(11000981) X:6 Y:1
namespace SagaScript.M30091004
{
    public class S11000981 : Event
    {
        public S11000981()
        {
            this.EventID = 11000981;
        }
        ...
        public override void OnEvent(ActorPC pc)
        {
            ...
            while (selection != 9)
            {
                switch (selection)
                {
                    ...
                    case 2:
                        Say(pc, 11000981, 131, "在进入「上城」的入口$R;" +
                                               "被警卫阻止了?$R;" +
                                               "$R您一定觉得很奇怪吧?$R;" +
                                               "「阿克罗波利斯」是自由贸易城市，$R;" +
                                               "可为什么无法自由的进出…$R;" +
                    ...
                    case 3:
                        Say(pc, 11000981, 131, "是说「阿克罗尼亚混成骑士团」吧?$R;" +
                                               "在「骑士团宫殿」那里受到劝诱吗?$R;" +
                                               "$R嗯…说到优点的话，$R;" +
                                               "应该说…$R;" +
                                               "可以自由出入军队所属的国家吧?$R;" +
                    ...
                    case 4:
                        Say(pc, 11000981, 131, "如果还没决定职业的话…$R;" +
                                               "$R开始的时候，$R;" +
                                               "还是选择战士系的$R;" +
                                               "「剑士」或「骑士」吧!$R;" +
                                               "比较容易熟悉适应环境。$R;", "老师");
                    ...
                    case 5:
                        Say(pc, 11000981, 131, "这么快就完成3个「任务」啦?$R;" +
                                               "呵呵!$R;" +
                                               "$R先把在「阿克罗波利斯」$R;" +
                                               "东、南、西、北平原的『木箱』打破吧!$R;" +
                                               "$P把箱子打破后，将得到『木箱』哦!$R;" +
                    ...
                    case 6:
                        Say(pc, 11000981, 131, "可能您还没见过『木箱』吧?$R;" +
                                               "$R但是『宝物箱』和『集装箱』里面，$R;" +
                                               "同样装有各种道具的喔!$R;" +
                                               "$P拜託「道具精制师」帮忙的话，$R;" +
                                               "他会帮您打开箱子的。$R;" +
        ...
        void 問題頁(ActorPC pc)
        {
            ...
            while (selection != 6)
            {
                ...
                {
                    case 1:
                        Say(pc, 11000981, 131, "别客气，安心的说吧!$R;" +
                                               "$P话虽如此，还是挺需要勇气的吧?$R;" +
                                               "$P如果害怕跟人交谈，$R;" +
                                               "我可以给您介绍一个功能喔!$R;" +
                                               "$R可以试试使用$R;" +
                    ...
                    case 2:
                        Say(pc, 11000981, 131, "想邀请对方加入队伍的话，$R;" +
                                               "用滑鼠右键点击对方，$R;" +
                                               "选择「邀请加入队伍」试试吧!$R;" +
                                               "$R对方就会显示邀请加入的视窗，$R;" +
                                               "如果忽然邀请的话，会吓着对方的。$R;" +
                    ...
                    case 3:
                        Say(pc, 11000981, 131, "好像听到了广播啊?$R;" +
                                               "$R「骑士团演习」$R;" +
                                               "简单的说，$R;" +
                                               "就是玩家们分为东、南、西、北军后，$R;" +
                                               "进行的模拟战斗。$R;" +
                    ...
                    case 4:
                        Say(pc, 11000981, 131, "嗯，宠物的种类虽然很多…$R;" +
                                               "$R但是，到「玩家商店」那里买的话，$R;" +
                                               "是最简单的。$R;" +
                                               "$P想在商店里购买的话，$R;" +
                                               "可以去「东方海角」的「宠物店」。$R;" +
                    ...
                    case 5:
                        Say(pc, 11000981, 131, "听说「阿克罗波利斯」的「上城」$R;" +
                                               "有个分发活动木偶的女孩…$R;" +
                                               "$P好像叫…埃琳娜?$R;" +
                                               "听说是个可爱的泰达尼亚女孩，$R;" +
                                               "$R下次去看看吧!$R;", "老师");
        ...
        void 困難頁(ActorPC pc)
        {
            ...
            while (selection != 6)
            {
                switch (selection)
                {
                    ...
                    case 3:
                        Say(pc, 11000981, 131, "装备得持久度降到0的话，$R;" +
                                               "图示会变成半透明，就无法装备了。$R;" +
                                               "$R那是道具「损坏」的意思。$R;" +
                                               "$P但是不代表，$R;" +
                                               "永远不能使用那道具。$R;" +
                    ...
                    case 4:
                        Say(pc, 11000981, 131, "什么…宠物的图示$R;" +
                                               "要是变成半透明的话，$R;" +
                                               "就不能带它出去了?$R;" +
                                               "$R请放心吧，那个不是指宠物死了。$R;" +
                                               "$R只是「亲密度」跌到0而已!$R;" +
