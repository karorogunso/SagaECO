...
namespace 海底副本
{
    public partial class 海底副本 : Event
    {
        ...
        string RealmName = "海底副本";
        void 寒流单人(ActorPC pc)
        {
            Difficulty diff = Difficulty.Single_Easy;
            switch (Select(pc, "请选择【" + RealmName + "】的难度(单人)", "", "单人普通（22任务点）", "离开"))
            {
                case 1:
        ...
        void 寒流多人(ActorPC pc)
        {
            Difficulty diff = Difficulty.Easy;
            switch (Select(pc, "请选择【" + RealmName + "】的难度(多人)", "", "多人普通（4人，15任务点）", "离开"))
            {
                case 1:
