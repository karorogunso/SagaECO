...
namespace WeeklyExploration
{
    public partial class GQuest : Event
    {
        ...
        ActorMob.MobInfo S10810101Info()
        {
            ActorMob.MobInfo info = new ActorMob.MobInfo();
            info.maxhp = 150000;//血量
            info.name = "自爆甲虫";
            info.speed = 520;//移動速度
        ...
        AIMode S10810101AI()
        {
            ...
            ai.SkillOfShort.Add(7758, skillinfo);//將這個技能加進進程技能表
            ai.SkillOfLong.Add(7758, skillinfo);//將這個技能加進進程技能表
            ...
            skillinfo.MaxHP = 100;//低於100%血量的時候才會釋放
            skillinfo.MinHP = 0;//高於0%血量的時候才會釋放
            ai.SkillOfShort.Add(7568, skillinfo);//將這個技能加進進程技能表
            ai.SkillOfLong.Add(7568, skillinfo);//將這個技能加進進程技能表
