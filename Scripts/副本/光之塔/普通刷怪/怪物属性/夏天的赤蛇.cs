...
namespace WeeklyExploration
{
    public partial class GQuest : Event
    {
        ...
        ActorMob.MobInfo S10450100Info()
        {
            ActorMob.MobInfo info = new ActorMob.MobInfo();
            info.maxhp = 188888;//血量
            info.name = "夏天的赤蛇";
            info.speed = 520;//移動速度
        ...
        AIMode S10450100AI()
        {
            ...
            ai.SkillOfShort.Add(7556, skillinfo);//將這個技能加進進程技能表
            ai.SkillOfLong.Add(7556, skillinfo);//將這個技能加進進程技能表
            ...
            skillinfo.MaxHP = 100;//低於100%血量的時候才會釋放
            skillinfo.MinHP = 0;//高於0%血量的時候才會釋放
            ai.SkillOfShort.Add(7557, skillinfo);//將這個技能加進進程技能表
            ai.SkillOfLong.Add(7557, skillinfo);//將這個技能加進進程技能表
