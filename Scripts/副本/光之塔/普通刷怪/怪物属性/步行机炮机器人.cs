...
namespace WeeklyExploration
{
    public partial class GQuest : Event
    {
        ...
        ActorMob.MobInfo S10820001Info()
        {
            ActorMob.MobInfo info = new ActorMob.MobInfo();
            info.maxhp = 240000;//血量
            info.name = "步行机炮机器人";
            info.speed = 520;//移動速度
            info.atk_min = 700;//最低物理攻擊
            info.atk_max = 1400;//最高物理攻擊
            info.matk_min = 450;//最低魔法攻擊
            info.matk_max = 700;//最高魔法攻擊
            info.def = 30;//物理左防
            info.mdef = 15;//魔法左防
            info.def_add = 80;//物理右防
            info.mdef_add = 80;//魔法右防
        ...
        AIMode S10820001AI()
        {
            ...
            skillinfo.MaxHP = 100;//低於100%血量的時候才會釋放
            skillinfo.MinHP = 0;//高於0%血量的時候才會釋放
            ai.SkillOfShort.Add(7533, skillinfo);//將這個技能加進進程技能表
            ai.SkillOfLong.Add(7533, skillinfo);//將這個技能加進進程技能
