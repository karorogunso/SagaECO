...
namespace WeeklyExploration
{
    public partial class GQuest : Event
    {
        ...
        ActorMob.MobInfo 老三Info困难()
        {
            ActorMob.MobInfo info = new ActorMob.MobInfo();
            info.maxhp = 7145925;//血量 
            info.name = "？？？";
            info.speed = 650;//移動速度
            info.atk_min = 1500;//最低物理攻擊
            info.atk_max = 2800;//最高物理攻擊
            ...
            newDrop.ItemID = 10170800;//掉落物品ID
        ...
        AIMode 老三AI困难()
        {
            ...
            /*---------恶鬼之道---------*/
            skillinfo = new AIMode.SkilInfo();
            skillinfo.CD = 57;//技能CD
            skillinfo.Rate = 20;//釋放概率
            skillinfo.MaxHP = 95;//低於100%血量的時候才會釋放
            skillinfo.MinHP = 0;//高於0%血量的時候才會釋放
            ai.SkillOfShort.Add(31065, skillinfo);//將這個技能加進進程技能表
            ai.SkillOfLong.Add(31065, skillinfo);//將這個技能加進進程技能表
            ...
            skillinfo.MinHP = 0;//高於0%血量的時候才會釋放
            ai.SkillOfShort.Add(31067, skillinfo);//將這個技能加進進程技能表
            ai.SkillOfLong.Add(31067, skillinfo);//將這個技能加進進程技能表
