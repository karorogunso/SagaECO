...
namespace WeeklyExploration
{
    public partial class GQuest : Event
    {
        ...
        ActorMob.MobInfo 老一Info困难()
        {
            ActorMob.MobInfo info = new ActorMob.MobInfo();
            info.maxhp = 5245925;//血量 
            info.range = 7;
            info.name = "？？？";
            info.speed = 650;//移動速度
            info.atk_min = 1500;//最低物理攻擊
            info.atk_max = 2000;//最高物理攻擊
            info.matk_min = 1300;//最低魔法攻擊
            info.matk_max = 1700;//最高物理攻擊
            info.def = 20;//物理左防
            info.mdef = 20;//魔法左防
            ...
            /*---------物理掉落---------*/
            newDrop.ItemID = 910000054;//掉落物品ID
            ...
            newDrop.ItemID = 10169500;//掉落物品ID
        ...
        AIMode 老一AI困难()
        {
            ...
            ai.SkillOfShort.Add(31057, skillinfo);//將這個技能加進進程技能表
            ai.SkillOfLong.Add(31057, skillinfo);//將這個技能加進進程技能表
            ...
            skillinfo.MaxHP = 95;//低於100%血量的時候才會釋放
            skillinfo.MinHP = 20;//高於0%血量的時候才會釋放
            ai.SkillOfShort.Add(31053, skillinfo);//將這個技能加進進程技能表
            ai.SkillOfLong.Add(31053, skillinfo);//將這個技能加進進程技能表
            ...
            skillinfo.MaxHP = 95;//低於100%血量的時候才會釋放
            skillinfo.MinHP = 20;//高於0%血量的時候才會釋放
            ai.SkillOfShort.Add(31054, skillinfo);//將這個技能加進進程技能表
            ai.SkillOfLong.Add(31054, skillinfo);//將這個技能加進進程技能表
            ...
            skillinfo.MaxHP = 95;//低於100%血量的時候才會釋放
            skillinfo.MinHP = 20;//高於0%血量的時候才會釋放
            ai.SkillOfShort.Add(31055, skillinfo);//將這個技能加進進程技能表
            ai.SkillOfLong.Add(31055, skillinfo);//將這個技能加進進程技能表
            ...
            skillinfo.MaxHP = 95;//低於100%血量的時候才會釋放
            skillinfo.MinHP = 20;//高於0%血量的時候才會釋放
            ai.SkillOfShort.Add(31056, skillinfo);//將這個技能加進進程技能表
            ai.SkillOfLong.Add(31056, skillinfo);//將這個技能加進進程技能表
