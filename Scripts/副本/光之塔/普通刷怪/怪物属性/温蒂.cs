...
namespace WeeklyExploration
{
    public partial class GQuest : Event
    {
        ...
        ActorMob.MobInfo S10860017Info()
        {
        ...
        AIMode S10860017AI()
        {
            ...
            ai.SkillOfShort.Add(7709, skillinfo);//將這個技能加進進程技能表
            ai.SkillOfLong.Add(7709, skillinfo);//將這個技能加進進程技能表
            ...
            ai.SkillOfLong.Add(3312, skillinfo);//將這個技能加進進程技能表
