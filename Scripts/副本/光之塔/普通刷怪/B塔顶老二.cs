...
namespace WeeklyExploration
{
    public partial class GQuest : Event
    {
        ...
        void 光之塔老二刷怪(uint mapid, ActorPC pc)
        {
            SagaMap.Map map;
            map = SagaMap.Manager.MapManager.Instance.GetMap(mapid);
            ActorMob mob = map.SpawnCustomMob(10000000, map.ID, 18630000, 0, 0, 92, 164, 0, 1, 0, 老二Info(), 老二AI(), (MobCallback)BOSS2死亡Ondie, 1)[0];
        ...
        private void SQuest_Defending2(MobEventHandler eh, ActorPC pc)
        {
            ...
            if (eh.mob.AttackedForEvent == 1)
            {
                ...
                if (mob.HP < 50)
                {
                    ...
                    光之塔老三刷怪((uint)pc.Party.Leader.TInt["S20163000"], pc);
        ...
        void BOSS2死亡Ondie(MobEventHandler e, ActorPC pc)
        {
