...
namespace WeeklyExploration
{
    public partial class GQuest : Event
    {
        ...
        void 光之塔老三刷怪(uint mapid, ActorPC pc)
        {
            SagaMap.Map map;
            map = SagaMap.Manager.MapManager.Instance.GetMap(mapid);
            ActorMob mob = map.SpawnCustomMob(10000000, map.ID, 18610050, 0, 0, 149, 63, 0, 1, 0, 老三Info(), 老三AI(), (MobCallback)BOSS3死亡Ondie, 1)[0];
        ...
        void BOSS3死亡Ondie(MobEventHandler e, ActorPC pc)
        {
