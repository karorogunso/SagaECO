...
namespace WeeklyExploration
{
    public partial class GQuest : Event
    {
        ...
        ActorMob.MobInfo 吴克Info()
        {
            ActorMob.MobInfo info = new ActorMob.MobInfo();
            info.maxhp = 1245925;//血量 
            info.name = "黑衣剑士·吴克";
            info.speed = 650;//移動速度
            ...
            /*---------物理掉落---------*/
            newDrop.ItemID = 910000039;//掉落物品ID
        ...
        AIMode 吴克AI()
        {
            ...
            ai.SkillOfShort.Add(31052, skillinfo);//將這個技能加進進程技能表
            ai.SkillOfLong.Add(31052, skillinfo);//將這個技能加進進程技能表
            ...
            skillinfo.MinHP = 0;//高於0%血量的時候才會釋放
            ai.SkillOfShort.Add(18203, skillinfo);//將這個技能加進進程技能表
            ai.SkillOfLong.Add(18203, skillinfo);//將這個技能加進進程技能表
            ...
            skillinfo.MaxHP = 100;//低於100%血量的時候才會釋放
            skillinfo.MinHP = 0;//高於0%血量的時候才會釋放
            ai.SkillOfShort.Add(18204, skillinfo);//將這個技能加進進程技能表
            ai.SkillOfLong.Add(18204, skillinfo);//將這個技能加進進程技能表
            ...
            skillinfo.MinHP = 0;//高於0%血量的時候才會釋放
            ai.SkillOfShort.Add(18004, skillinfo);//將這個技能加進進程技能表
            ai.SkillOfLong.Add(18004, skillinfo);//將這個技能加進進程技能表
