...
namespace WeeklyExploration
{
    public partial class GQuest : Event
    {
        ...
        ActorMob.MobInfo BOSS3Info()
        {
            ActorMob.MobInfo info = new ActorMob.MobInfo();
            info.maxhp = 1800000;//血量
            info.name = "？？？";
            info.speed = 1000;//移動速度
        ...
        AIMode BOSS3AI()
        {
            ...
            skillinfo.MaxHP =  100;//低於100%血量的時候才會釋放
            skillinfo.MinHP = 0;//高於0%血量的時候才會釋放
            ai.SkillOfShort.Add(2187, skillinfo);//將這個技能加進進程技能表
            ...
            skillinfo.MaxHP =  100;//低於100%血量的時候才會釋放
            skillinfo.MinHP = 0;//高於0%血量的時候才會釋放
            ai.SkillOfShort.Add(2137, skillinfo);//將這個技能加進進程技能表
            ...
            skillinfo.MaxHP =  100;//低於100%血量的時候才會釋放
            skillinfo.MinHP = 0;//高於0%血量的時候才會釋放
            ai.SkillOfShort.Add(31006, skillinfo);//將這個技能加進進程技能表
            ai.SkillOfLong.Add(31006, skillinfo);
            ...
            skillinfo.MinHP = 0;//高於0%血量的時候才會釋放
            ai.SkillOfShort.Add(31007, skillinfo);//將這個技能加進進程技能表
            ai.SkillOfLong.Add(31007, skillinfo);
            ...
            skillinfo.MaxHP =  100;//低於100%血量的時候才會釋放
            skillinfo.MinHP = 0;//高於0%血量的時候才會釋放
            ai.SkillOfShort.Add(31008, skillinfo);//將這個技能加進進程技能表
            ai.SkillOfLong.Add(31008, skillinfo);
            return ai;
        }
    }
}
