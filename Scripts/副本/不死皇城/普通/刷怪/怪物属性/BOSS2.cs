...
namespace WeeklyExploration
{
    public partial class GQuest : Event
    {
        ...
        AIMode BOSS2AI()
        {
            ...
            skillinfo.MinHP = 0;//高於0%血量的時候才會釋放
            ai.SkillOfShort.Add(31009, skillinfo);//將這個技能加進進程技能表
            ai.SkillOfLong.Add(31009, skillinfo);//將這個技能加進進程技能表
