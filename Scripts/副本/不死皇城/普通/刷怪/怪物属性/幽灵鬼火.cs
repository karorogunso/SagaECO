...
namespace WeeklyExploration
{
    public partial class GQuest : Event
    {
        ...
        ActorMob.MobInfo 幽灵鬼火Info()
        {
            ActorMob.MobInfo info = new ActorMob.MobInfo();
            info.maxhp =(uint)(1.5 *  45020);//血量
            info.name = "幽灵鬼火";
            info.speed = 900;//移動速度
            info.atk_min = 400;//最低物理攻擊
            info.atk_max = 950;//最高物理攻擊
            info.matk_min = 300;//最低魔法攻擊
            info.matk_max = 650;//最高物理攻擊
            info.def = 20;//物理左防
            info.mdef = 10;//魔法左防
        ...
        AIMode 幽灵鬼火AI()
        {
            ...
            skillinfo.MaxHP =  100;//低於100%血量的時候才會釋放
            skillinfo.MinHP = 0;//高於0%血量的時候才會釋放
            ai.SkillOfShort.Add(7535, skillinfo);//將這個技能加進進程技能表
            ai.SkillOfLong.Add(7535, skillinfo);//將這個技能加進進程技能表
            return ai;
        }
    }
}
