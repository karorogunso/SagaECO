...
namespace SagaScript.M30210000
{
    ...
    {
        ActorMob.MobInfo 鱼人阿鲁玛Info(bool single)
        {
            ...
            newDrop.ItemID = 10083400;//掉落物品ID
            ...
            newDrop.ItemID = 10173800;//掉落物品ID
            newDrop.Roll = true;
            newDrop.Rate = 300;//掉落幾率,10000是100%，5000是50%
            info.dropItems.Add(newDrop);
        ...
        AIMode 鱼人阿鲁玛AI()
        {
            ...
            ai.SkillOfLong.Add(31076, skillinfo);//將這個技能加進進程技能表
            ai.SkillOfShort.Add(31076, skillinfo);//將這個技能加進進程技能表
            ...
            skillinfo.MinHP = 0;//高於0%血量的時候才會釋放
            ai.SkillOfLong.Add(31077, skillinfo);//將這個技能加進進程技能表
            ai.SkillOfShort.Add(31077, skillinfo);//將這個技能加進進程技能表
            ...
            skillinfo.MinHP = 0;//高於0%血量的時候才會釋放
            ai.SkillOfLong.Add(31078, skillinfo);//將這個技能加進進程技能表
            ai.SkillOfShort.Add(31078, skillinfo);//將這個技能加進進程技能表
            ...
            skillinfo.MinHP = 0;//高於0%血量的時候才會釋放
            ai.SkillOfLong.Add(31079, skillinfo);//將這個技能加進進程技能表
            ai.SkillOfShort.Add(31079, skillinfo);//將這個技能加進進程技能表
            return ai;
        }
    }
}
