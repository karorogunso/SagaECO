...
namespace WeeklyExploration
{
    public partial class YugangdaoASpawn
    {
        ActorMob.MobInfo 小猪Info()
        {
            ...
            newDrop.ItemID = 10035000;//掉落物品ID
            newDrop.Rate = 2000;//掉落幾率,10000是100%，5000是50%
            info.dropItems.Add(newDrop);

            /*---------松软的肉---------*/
            newDrop = new MobData.DropData();
            newDrop.ItemID = 10082300;//掉落物品ID
            newDrop.Rate = 1000;//掉落幾率,10000是100%，5000是50%
            info.dropItems.Add(newDrop);

            /*---------小猪王冠---------*/
            newDrop = new MobData.DropData();
            newDrop.ItemID = 10082400;//掉落物品ID
            newDrop.Rate = 1200;//掉落幾率,10000是100%，5000是50%
            info.dropItems.Add(newDrop);
