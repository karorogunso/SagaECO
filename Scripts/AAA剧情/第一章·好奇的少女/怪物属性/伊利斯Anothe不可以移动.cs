...
{
    public partial class AAA序章怪物
    {
        public static ActorMob.MobInfo 伊利斯AnotherInfo()
        {
            ActorMob.MobInfo info = new ActorMob.MobInfo();
            info.name = "伊利斯Another";
            info.level = 100;
            info.maxhp = 500000000;
            info.speed = 800;
            info.atk_min = 480;
            info.atk_max = 860;
            info.matk_min = 117;
        ...
        public static AIMode 伊利斯AnotherAI()
        {
            AIMode ai = new AIMode(5); ai.MobID = 10000000; ai.isNewAI = true;//1為主動，0為被動
