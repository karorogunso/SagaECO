...
namespace SagaMap
{
    public class MapServer
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("            SagaECO Map Server - Internal Beta Version                ");
            ...
            if (!MapClientManager.Instance.StartNetwork(12001))
            {
                Logger.ShowError("cannot listen on port: " + 12001);
            ...
            Console.WriteLine(LocalManager.Instance.Strings.ACCEPTING_CLIENT);
