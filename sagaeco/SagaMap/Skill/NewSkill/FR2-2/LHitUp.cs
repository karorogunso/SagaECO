...
namespace SagaMap.Skill.SkillDefinations.Archer
{
    ...
    public class LHitUp:ISkill
    {
        ...
        void StartEventHandler(Actor actor, DefaultBuff skill)
        {
            ...
            float rate = 0.1f;
            short max_atk1 = (short)(actor.Status.max_atk_bs * rate);
            short max_atk2 = (short)(actor.Status.max_atk_bs * rate);
            short max_atk3 = (short)(actor.Status.max_atk_bs * rate);
            short min_atk1 = (short)(actor.Status.min_atk_bs * rate);
            short min_atk2 = (short)(actor.Status.min_atk_bs * rate);
            short min_atk3 = (short)(actor.Status.min_atk_bs * rate);
            short max_matk = (short)(actor.Status.max_matk_bs * rate);
            short min_matk = (short)(actor.Status.min_matk_bs * rate);
            short cri = 5;
            ...
            actor.Status.hit_critical_skill += cri;
        ...
        void EndEventHandler(Actor actor, DefaultBuff skill)
        {
            ...
            actor.Status.hit_critical_skill -= (short)skill.Variable["鹰怒CriUp"];
            if (actor.type == ActorType.PC)
            {
