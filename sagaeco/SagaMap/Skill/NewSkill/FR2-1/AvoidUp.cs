...
namespace SagaMap.Skill.SkillDefinations.Assassin
{
    ...
    public class AvoidUp : ISkill 
    {
        ...
        {
            DefaultPassiveSkill skill = new DefaultPassiveSkill(args.skill, sActor, "AvoidUp",false );
        ...
        void StartEventHandler(Actor actor, DefaultPassiveSkill skill)
        {
            ...
            //近戰迴避
            float[] avoid_melee_adds = { 0f, 0.05f, 0.07f, 0.11f };
            int avoid_melee_add = (int)(actor.Status.avoid_melee_bs * avoid_melee_adds[skill.skill.Level]);
            ...
            //遠距迴避
            float[] avoid_ranged_adds = { 0f, 0.05f, 0.07f, 0.11f };
            int avoid_ranged_add = (int)(actor.Status.avoid_ranged_bs * avoid_ranged_adds[skill.skill.Level]);
