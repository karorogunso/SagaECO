    ...
    public class S42300 : ISkill
    {
        ...
        public void Proc(Actor sActor, Actor dActor, SkillArg args, byte level)
        {
            ...
            if (sActor.type == ActorType.PC)
            {
                ...
                ElementContract ec = new ElementContract(args.skill, sActor, lifetime, Elements.Wind);
                SkillHandler.ApplyAddition(sActor, ec);
                WeaponWind w = new WeaponWind(args.skill, sActor, lifetime, 10);
