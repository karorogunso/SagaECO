    ...
    public class S42400 : ISkill
    {
        ...
        public void Proc(Actor sActor, Actor dActor, SkillArg args, byte level)
        {
            ...
            if(sActor.type == ActorType.PC)
            {
                ...
                ElementContract ec = new ElementContract(args.skill, sActor, lifetime, Elements.Earth);
                SkillHandler.ApplyAddition(sActor, ec);
                WeaponEarth w = new WeaponEarth(args.skill, sActor, lifetime, 10);
