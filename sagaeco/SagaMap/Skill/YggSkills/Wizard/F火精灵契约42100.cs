    ...
    public class S42100 : ISkill
    {
        ...
        public void Proc(Actor sActor, Actor dActor, SkillArg args, byte level)
        {
            ...
            if (sActor.type == ActorType.PC)
            {
                ...
                ElementContract ec = new ElementContract(args.skill, sActor, lifetime, Elements.Fire);
                SkillHandler.ApplyAddition(sActor, ec);
                WeaponFire w = new WeaponFire(args.skill, sActor, lifetime, 10);
