    ...
    public class S42200 : ISkill
    {
        ...
        public void Proc(Actor sActor, Actor dActor, SkillArg args, byte level)
        {
            ...
            if (sActor.type == ActorType.PC)
            {
                ...
                ElementContract ec = new ElementContract(args.skill, sActor, lifetime, Elements.Water);
                SkillHandler.ApplyAddition(sActor, ec);
                WeaponWater w = new WeaponWater(args.skill, sActor, lifetime, 10);
