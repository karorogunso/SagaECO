...
namespace SagaMap.Skill.SkillDefinations
{
    public class S40202 : ISkill
    {
        ...
        public void Proc(Actor sActor, Actor dActor, SkillArg args, byte level)
        {
            ...
            if (sActor.Status.Additions.ContainsKey("炎龙斩")) SkillHandler.RemoveAddition(sActor, "炎龙斩");
            ...
            OtherAddition oa = new OtherAddition(args.skill, sActor, "圣光之矛", 60000);
