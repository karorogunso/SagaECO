    ...
    public class S26503:ISkill
    {
        ...
        public void Proc(Actor sActor, Actor dActor, SkillArg args, byte level)
        {
            ...
            if (sActor.type == ActorType.PC)
            {
                ...
                DefaultPassiveSkill skill = new DefaultPassiveSkill(args.skill, sActor, "Enchant26503", active, amount);
        ...
        void StartEventHandler(Actor actor, DefaultPassiveSkill buff)
        {
            if (actor.type == ActorType.PC)
            {
                ...
                if (buff.Variable.ContainsKey("Enchant26503ElementUP"))
                    buff.Variable.Remove("Enchant26503ElementUP");
                buff.Variable.Add("Enchant26503ElementUP", Elementvalue);

                if (buff.Variable.ContainsKey("Enchant26503CustomvalueUP"))
                    buff.Variable.Remove("Enchant26503CustomvalueUP");
                buff.Variable.Add("Enchant26503CustomvalueUP", Customvalue);
        ...
        void EndEventHandler(Actor actor, DefaultPassiveSkill buff)
        {
            if (actor.type == ActorType.PC)
            {
                int Elementvalue = buff.Variable["Enchant26503ElementUP"];
                int Customvalue = buff.Variable["Enchant26503CustomvalueUP"];
