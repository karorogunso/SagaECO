    ...
    public class FlashLight:ISkill 
    {
        ...
        private class Activator : MultiRunTask
        {
                ...
                try
                {
                    if (count < times)
                    {
                        ...
                        foreach (Actor i in actors)
                        {
                            ...
                            {
                                DefaultBuff askill = new DefaultBuff(skill.skill, i, "FlashLight", 30000);
            ...
            void StartEventHandler(Actor actor, DefaultBuff skill)
            {
                ...
                //遠命中
                int hit_ranged_add = (int)(actor.Status.hit_ranged_bs * (0.05f - 0.1f * level));
                if (skill.Variable.ContainsKey("FlashLight_hit_ranged"))
                    skill.Variable.Remove("FlashLight_hit_ranged");
                skill.Variable.Add("FlashLight_hit_ranged", hit_ranged_add);
