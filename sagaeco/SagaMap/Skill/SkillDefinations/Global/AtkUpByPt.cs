...
namespace SagaMap.Skill.SkillDefinations.Global
{
    ...
    public class AtkUpByPt : ISkill
    {
        ...
        public void StartEventHandler(Actor actor, DefaultPassiveSkill skill)
        {
            ...
            //最大攻擊
            int max_atk1_add = (int)(actor.Status.max_atk_bs  * (-0.01f + 0.02f * level));
            ...
            //最大攻擊
            int max_atk2_add = (int)(actor.Status.max_atk_bs * (-0.01f + 0.02f * level));
            ...
            //最大攻擊
            int max_atk3_add = (int)(actor.Status.max_atk_bs * (-0.01f + 0.02f * level));
            ...
            //最小攻擊
            int min_atk1_add = (int)(actor.Status.min_atk_bs  * (-0.01f + 0.02f * level));
            ...
            //最小攻擊
            int min_atk2_add = (int)(actor.Status.min_atk_bs * (-0.01f + 0.02f * level));
            ...
            //最小攻擊
            int min_atk3_add = (int)(actor.Status.min_atk_bs * (-0.01f + 0.02f * level));
