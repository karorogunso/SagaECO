                    ...
                    if (!SkillHandler.Instance.isBossMob(i))
                    {
                        switch (SagaLib.Global.Random.Next(1, 3))
                        {
                            case 1:
                                ...
                                break;
                            case 2:
                                Additions.Global.Poison1 Poison = new SagaMap.Skill.Additions.Global.Poison1(null, i, lifetime[level]);
                                SkillHandler.ApplyAddition(i, Poison);
                                break;
                            case 3:
                                Additions.Global.鈍足 Sleep = new SagaMap.Skill.Additions.Global.鈍足(null, i, lifetime[level]);
