...
namespace SagaMap.Skill.SkillDefinations.Assassin
{
    ...
    public class PoisonReate3 :  ISkill 
    {
        ...
        void StartEventHandler(Actor actor, DefaultBuff skill)
        {
            ...
            {
                case 1:
                    max_atk_add = (int)(0.07 * actor.Status.max_atk_bs);
                    min_atk_add = (int)(0.07 * actor.Status.min_atk_bs);
                    rate = 0;
                    break;
                case 2:
                    max_atk_add = (int)(0.09 * actor.Status.max_atk_bs);
                    min_atk_add = (int)(0.09 * actor.Status.min_atk_bs);
                    rate = 12;
                    break;
                case 3:
                    max_atk_add = (int)(0.11 * actor.Status.max_atk_bs);
                    min_atk_add = (int)(0.11 * actor.Status.min_atk_bs);
                    rate = 24;
                    break;
                case 4:
                    max_atk_add = (int)(0.13 * actor.Status.max_atk_bs);
                    min_atk_add = (int)(0.13 * actor.Status.min_atk_bs);
                    rate = 36;
                    break;
                case 5:
                    max_atk_add = (int)(0.15 * actor.Status.max_atk_bs);
                    min_atk_add = (int)(0.15 * actor.Status.min_atk_bs);
                    rate = 50;
                    break;
            }
            int aspd_add = (int)(actor.Status.aspd_bs * spd);
            //大傷
            ...
            {
                Additions.Global.Poison1 nskill = new SagaMap.Skill.Additions.Global.Poison1(skill.skill , actor, 7000);
