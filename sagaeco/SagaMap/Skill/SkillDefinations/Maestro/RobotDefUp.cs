...
namespace SagaMap.Skill.SkillDefinations.Maestro
{
    class RobotDefUp : ISkill
    {
        ...
        void StartEventHandler(Actor actor, DefaultBuff skill)
        {
            ...
            skill.Variable.Add("RobotDefUp", (int)(actor.Status.def_add_bs * rank));
            actor.Status.def_add_skill += (short)(actor.Status.def_add_bs * rank);

            if (skill.Variable.ContainsKey("RobotDefUp2"))
                skill.Variable.Remove("RobotDefUp2");
            skill.Variable.Add("RobotDefUp2", (int)(actor.Status.def_bs * rank));
            actor.Status.def_skill += (short)(actor.Status.def_bs * rank);
