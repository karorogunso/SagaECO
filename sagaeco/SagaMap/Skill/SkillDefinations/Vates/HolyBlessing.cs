...
namespace SagaMap.Skill.SkillDefinations.Vates
{
    public class HolyBlessing : ISkill
    {
        ...
        {
            short maxatk1 = (short)(actor.Status.max_atk_bs * (float)(0.2f + (skill.skill.Level * 0.02f)));
            short maxatk2 = (short)(actor.Status.max_atk_bs * (float)(0.2f + (skill.skill.Level * 0.02f)));
            short maxatk3 = (short)(actor.Status.max_atk_bs * (float)(0.2f + (skill.skill.Level * 0.02f)));
            short minatk1 = (short)(actor.Status.min_atk_bs * (float)(0.2f + (skill.skill.Level * 0.02f)));
            short minatk2 = (short)(actor.Status.min_atk_bs * (float)(0.2f + (skill.skill.Level * 0.02f)));
            short minatk3 = (short)(actor.Status.min_atk_bs * (float)(0.2f + (skill.skill.Level * 0.02f)));
            short maxmatk = (short)(actor.Status.max_matk_bs * (float)(0.2f + (skill.skill.Level * 0.02f)));
            short minmatk = (short)(actor.Status.min_matk_bs * (float)(0.2f + (skill.skill.Level * 0.02f)));
