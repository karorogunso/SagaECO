...
namespace SagaMap.Skill.SkillDefinations.Event
{
    ...
    public class Ryuugankaihou : ISkill
    {
        ...
        {
            int lifetime = 30000;
            DefaultBuff skill = new DefaultBuff(args.skill, dActor, "Ryuugankaihou", lifetime);
        ...
        void StartEventHandler(Actor actor, DefaultBuff skill)
        {
            ...
            skill.Variable.Add("Ryuugankaihou_max_atk1", max_atk1_add);
            ...
            skill.Variable.Add("Ryuugankaihou_max_atk2", max_atk2_add);
            ...
            skill.Variable.Add("Ryuugankaihou_max_atk3", max_atk3_add);
            ...
            skill.Variable.Add("Ryuugankaihou_min_atk1", min_atk1_add);
            ...
            skill.Variable.Add("Ryuugankaihou_min_atk2", min_atk2_add);
            actor.Status.min_atk2_skill += (short)min_atk2_add;

            //最小攻擊
            int min_atk3_add = (int)(actor.Status.min_atk_bs * factor);
            if (skill.Variable.ContainsKey("Ryuugankaihou_min_atk3"))
                skill.Variable.Remove("Ryuugankaihou_min_atk3");
            skill.Variable.Add("Ryuugankaihou_min_atk3", min_atk3_add);
