...
namespace SagaMap.Skill.SkillDefinations.Command
{
    ...
    public class HandGunDamUp : ISkill 
    {
        ...
        {
            DefaultPassiveSkill skill = new DefaultPassiveSkill(args.skill, sActor, "HandGunDamUp", false);
        ...
        void StartEventHandler(Actor actor, DefaultPassiveSkill skill)
        {
            ...
            //遠命中
            int hit_ranged_add = (int)(Math.Floor(actor.Status.hit_ranged_bs * (0.01f * (skill.skill.Level + 1)) + skill.skill.Level));
