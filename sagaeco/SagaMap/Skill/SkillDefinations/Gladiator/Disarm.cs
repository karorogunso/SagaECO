...
namespace SagaMap.Skill.SkillDefinations.Gladiator
{
    ...
    public class Disarm : ISkill
    {
        ...
        void StartEventHandlerMOB(Actor actor, DefaultBuff skill)
        {
            ...
            actor.Status.max_atk1_skill -= (short)(actor.Status.max_atk_bs * atkdowm);
            actor.Status.max_atk2_skill -= (short)(actor.Status.max_atk_bs * atkdowm);
            actor.Status.max_atk3_skill -= (short)(actor.Status.max_atk_bs * atkdowm);
            actor.Status.min_atk1_skill -= (short)(actor.Status.min_atk_bs * atkdowm);
            actor.Status.min_atk2_skill -= (short)(actor.Status.min_atk_bs * atkdowm);
            actor.Status.min_atk3_skill -= (short)(actor.Status.min_atk_bs * atkdowm);
            actor.Status.max_matk_skill -= (short)(actor.Status.max_matk_bs * atkdowm);
            actor.Status.min_matk_skill -= (short)(actor.Status.min_matk_bs * atkdowm);
        }
