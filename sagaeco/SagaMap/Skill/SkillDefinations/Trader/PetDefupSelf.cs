...
namespace SagaMap.Skill.SkillDefinations.Trader
{
    ...
    public class PetDefupSelf : ISkill
    {
        ...
        void StartEventHandler(Actor actor, DefaultBuff skill)
        {
            ...
            //左防禦
            int def_add = (int)(actor.Status.def_bs * 5 * level);
            ...
            //右防禦
            int def_add_add = (int)(actor.Status.def_add_bs * 8 + 2 * level);
            ...
            //左魔防
            int mdef_add = (int)(actor.Status.mdef_bs * 4 + level);
            ...
            //右魔防
            int mdef_add_add = (int)(actor.Status.mdef_add_bs * 5 + 2 * level);
