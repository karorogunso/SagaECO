        ...
        public class SummobLemuresBuff : DefaultBuff
        {
            ...
            void StartEvent(Actor actor, DefaultBuff skill)
            {
                ...
                if (actor.type == ActorType.PC)
                {
                    ...
                    {
                        mob.Status.max_matk_skill += (short)(pc.Skills2[LemuresMatkUp_SkillID].Level * 0.3f * actor.Status.max_matk_bs);
                        mob.Status.min_matk_skill += (short)(pc.Skills2[LemuresMatkUp_SkillID].Level * 0.3f * actor.Status.min_matk_bs);
                    }
                    else if (pc.SkillsReserve.ContainsKey(LemuresMatkUp_SkillID))
                    {
                        mob.Status.max_matk_skill += (short)(pc.SkillsReserve[LemuresMatkUp_SkillID].Level * 0.3f * actor.Status.max_matk_bs);
                        mob.Status.min_matk_skill += (short)(pc.SkillsReserve[LemuresMatkUp_SkillID].Level * 0.3f * actor.Status.min_matk_bs);
                    }
                    ...
                    {
                        //最大攻擊
                        mob.Status.max_atk1_skill += (short)(actor.Status.max_atk_bs * pc.Skills2[LemuresAtkUp_SkillID].Level * 0.3f);
                        mob.Status.max_atk2_skill += (short)(actor.Status.max_atk_bs * pc.Skills2[LemuresAtkUp_SkillID].Level * 0.3f);
                        mob.Status.max_atk3_skill += (short)(actor.Status.max_atk_bs * pc.Skills2[LemuresAtkUp_SkillID].Level * 0.3f);
                        //最小攻擊
                        mob.Status.min_atk1_skill += (short)(actor.Status.min_atk_bs * pc.Skills2[LemuresAtkUp_SkillID].Level * 0.3f);
                        mob.Status.min_atk2_skill += (short)(actor.Status.min_atk_bs * pc.Skills2[LemuresAtkUp_SkillID].Level * 0.3f);
                        mob.Status.min_atk3_skill += (short)(actor.Status.min_atk_bs * pc.Skills2[LemuresAtkUp_SkillID].Level * 0.3f);
                    }
                    else if (pc.SkillsReserve.ContainsKey(LemuresAtkUp_SkillID))
                    {
                        //最大攻擊
                        mob.Status.max_atk1_skill += (short)(actor.Status.max_atk_bs * pc.SkillsReserve[LemuresAtkUp_SkillID].Level * 0.3f);
                        mob.Status.max_atk2_skill += (short)(actor.Status.max_atk_bs * pc.SkillsReserve[LemuresAtkUp_SkillID].Level * 0.3f);
                        mob.Status.max_atk3_skill += (short)(actor.Status.max_atk_bs * pc.SkillsReserve[LemuresAtkUp_SkillID].Level * 0.3f);
                        //最小攻擊
                        mob.Status.min_atk1_skill += (short)(actor.Status.min_atk_bs * pc.SkillsReserve[LemuresAtkUp_SkillID].Level * 0.3f);
