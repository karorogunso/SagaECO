...
namespace SagaMap.Skill.SkillDefinations.Royaldealer
{
    ...
    /// ディーラーの手腕
    /// </summary>
    public class Royaldealer : ISkill
    {
        ...
        {
            DefaultPassiveSkill skill = new DefaultPassiveSkill(args.skill, dActor, "Royaldealer", true);
        ...
        void EndEventHandler(Actor actor, DefaultPassiveSkill skill)
        {
            ...
            //爆擊率
            actor.Status.hit_critical_skill -= (short)skill.Variable["SwordMaster_cri"];
