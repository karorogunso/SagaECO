...
namespace SagaMap.Skill.SkillDefinations.Enchanter
{
    ...
    public class AtkUp_DefUp_SpdDown_AvoDown:ISkill 
    {
        ...
        void StartEventHandler(Actor actor, DefaultBuff skill)
        {
            ...
            //攻擊速度
            int aspd_add = -(int)(actor.Status.aspd_bs * (0.07f + 0.02f * level));
            ...
            //詠唱速度
            int cspd_add = -(int)(actor.Status.cspd_bs * (0.07f + 0.02f * level));
            ...
            //近戰迴避
            int avoid_melee_add = -(int)(actor.Status.avoid_melee_bs * (0.11f + 0.03f * level));
