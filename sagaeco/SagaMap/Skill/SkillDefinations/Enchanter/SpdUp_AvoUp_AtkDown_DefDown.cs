...
namespace SagaMap.Skill.SkillDefinations.Enchanter
{
    ...
    public class SpdUp_AvoUp_AtkDown_DefDown : ISkill
    {
        ...
        void StartEventHandler(Actor actor, DefaultBuff skill)
        {
            ...
            int atk_add=(int)(actor.Status.min_atk_bs * atk);
            int matk_add = (int)(actor.Status.min_matk_bs * atk);
            int avo_add = (int)(actor.Status.avoid_ranged_bs * avo);
            int def_add = (int)(actor.Status.def_bs * def);
            int mdef_add = (int)(actor.Status.mdef_bs * def);
            int aspd_add = (int)(actor.Status.aspd_bs * spd);
            int cspd_add = (int)(actor.Status.cspd_bs * spd);
            //最小攻擊
