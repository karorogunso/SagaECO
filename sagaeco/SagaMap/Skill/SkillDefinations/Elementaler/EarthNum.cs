...
namespace SagaMap.Skill.SkillDefinations.Elementaler
{
    class EarthNum:ISkill
    {
        ...
        public void Proc(Actor sActor, Actor dActor, SkillArg args, byte level)
        {
            ...
            element_dActor = dActor.Elements[SagaLib.Elements.Earth] + dActor.Status.elements_item[SagaLib.Elements.Earth] + dActor.Status.elements_iris[SagaLib.Elements.Earth] + dActor.Status.elements_skill[SagaLib.Elements.Earth];
