...
namespace SagaMap.Skill.SkillDefinations.Elementaler
{
    ...
    public class Zen:ISkill
    {
        ...
        {
            short maxmatk = (short)(actor.Status.max_matk_bs * (float)(0.7f + skill.skill.Level * 0.3f));
            short minmatk = (short)(actor.Status.min_matk_bs * (float)(0.7f + skill.skill.Level * 0.3f));
