...
namespace SagaMap.Skill.SkillDefinations.Elementaler
{
    class WaterNum:ISkill
    {
        ...
        public void Proc(Actor sActor, Actor dActor, SkillArg args, byte level)
        {
            int rate = 0;
            int lifetime = 0;
            SkillHandler.Instance.MagicAttack(sActor, dActor, args, SagaLib.Elements.Water, 0);
            ...
            element_dActor = dActor.Elements[SagaLib.Elements.Water] + dActor.Status.elements_item[SagaLib.Elements.Water] + dActor.Status.elements_iris[SagaLib.Elements.Water] + dActor.Status.elements_skill[SagaLib.Elements.Water];
