...
namespace SagaMap.Skill.SkillDefinations.Knight
{
    ...
    public class HitRow : ISkill
    {
        ...
        void StartEventHandler(Actor actor, DefaultBuff skill)
        {
            ...
            int atk1 = (int)(actor.Status.min_atk_bs * rate[skill.skill.Level]);
            int atk2 = (int)(actor.Status.min_atk_bs * rate[skill.skill.Level]);
            int atk3 = (int)(actor.Status.min_atk_bs * rate[skill.skill.Level]);
