...
namespace SagaMap.Skill.SkillDefinations.Alchemist
{
    ...
    public class PlaDamUp : ISkill
    {
        ...
        void StartEventHandler(Actor actor, DefaultPassiveSkill skill)
        {
            ...
            int addmaxatk1 = (int)(actor.Status.max_atk_bs * rate);
            int addmaxatk2 = (int)(actor.Status.max_atk_bs * rate);
            int addmaxatk3 = (int)(actor.Status.max_atk_bs * rate);
            int addminatk1 = (int)(actor.Status.min_atk_bs * rate);
            int addminatk2 = (int)(actor.Status.min_atk_bs * rate);
            int addminatk3 = (int)(actor.Status.min_atk_bs * rate);
            int addmaxmatk = (int)(actor.Status.max_matk_bs * rate);
            int addminmatk = (int)(actor.Status.min_matk_bs * rate);
