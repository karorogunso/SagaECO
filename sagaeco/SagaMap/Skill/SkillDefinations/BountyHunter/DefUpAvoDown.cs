...
namespace SagaMap.Skill.SkillDefinations.BountyHunter
{
    ...
    public class DefUpAvoDown : ISkill
    {
        ...
        void StartEventHandler(Actor actor, DefaultBuff skill)
        {
            ...
            int avo_range_down = -(int)(actor.Status.avoid_ranged_bs * 0.1f * level);
            int avo_melee_down = -(int)(actor.Status.avoid_melee_bs * 0.1f * level);
            int def_add_add = (int)(actor.Status.def_add_bs * (0.1f + 0.1f * level));
            int def_add = (int)(actor.Status.def_bs * (0.1f + 0.1f * level));
            //avo_range_down
