...
namespace SagaMap.Skill.SkillDefinations.Explorer
{
    ...
    public class Blinding : ISkill
    {
        ...
        void StartEventHandler(Actor actor, DefaultBuff skill)
        {
            ...
            //近命中
            int hit_melee_add = -(int)(actor.Status.hit_melee_bs * (0.32f + 0.04f * level));
            ...
            //遠命中
            int hit_ranged_add = -(int)(actor.Status.hit_ranged_bs * (0.27f + 0.04f * level));
