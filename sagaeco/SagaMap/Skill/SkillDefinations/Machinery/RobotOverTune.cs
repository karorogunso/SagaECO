...
namespace SagaMap.Skill.SkillDefinations.Machinery
{
    ...
    public class RobotOverTune : ISkill
    {
        ...
        void StartEventHandler(Actor actor, DefaultBuff skill)
        {
            ...
            //最大攻擊
            int max_atk2_add = (int)(actor.Status.max_atk_bs * (0.05f + 0.1f * level));
            ...
            //最大攻擊
            int max_atk3_add = (int)(actor.Status.max_atk_bs * (0.05f + 0.1f * level));
            ...
            //最小攻擊
            int min_atk2_add = (int)(actor.Status.min_atk_bs * (0.05f + 0.1f * level));
            ...
            //最小攻擊
            int min_atk3_add = (int)(actor.Status.min_atk_bs * (0.05f + 0.1f * level));
            ...
            //最大魔攻
            int max_matk_add = (int)(actor.Status.max_matk_bs * (0.05f + 0.1f * level));
            ...
            //最小魔攻
            int min_matk_add = (int)(actor.Status.min_matk_bs * (0.05f + 0.1f * level));
