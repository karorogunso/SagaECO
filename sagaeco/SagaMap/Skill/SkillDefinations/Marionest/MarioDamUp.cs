...
namespace SagaMap.Skill.SkillDefinations.Marionest
{
    ...
    public class MarioDamUp : ISkill
    {
        ...
        void StartEventHandler(Actor actor, DefaultPassiveSkill skill)
        {
            ...
            //最小魔攻
            int min_matk_add = (int)(actor.Status.min_matk_bs * (0.07f + 0.03f * level));
            ...
            //左防禦
            int def_add = (int)(actor.Status.def_bs * (0.07f + 0.03f * level));
            ...
            //右防禦
            int def_add_add = (int)(actor.Status.def_add_bs * (0.07f + 0.03f * level));
            ...
            //左魔防
            int mdef_add = (int)(actor.Status.mdef_bs * (0.07f + 0.03f * level));
            ...
            //右魔防
            int mdef_add_add = (int)(actor.Status.mdef_add_bs * (0.07f + 0.03f * level));
