                ...
                try
                {
                    for (int i = 0; i < paths.Count; i++)
                    {
                        ...
                        foreach (Actor j in actors)
                        {
                            ...
                            {
                                int damage = SkillHandler.Instance.CalcDamage(true, caster, j, skill, SkillHandler.DefType.IgnoreAll, Elements.Wind, 50, 15f);
