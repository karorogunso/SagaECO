...
namespace SagaMap.Skill.SkillDefinations
{
    public class S31071 : ISkill
    {
        ...
        {
            SkillHandler.Instance.PhysicalAttack(sActor,dActor, args, Elements.Fire, 2f);
            ...
            {
                short[] pos;
                pos = map.GetRandomPosAroundPos(dActor.X, dActor.Y, 2500);
                ...
                try
                {
                    if (timecount < timecountmax)
                    {
                        ...
                        foreach (Actor i in actors)
                        {
                            ...
                            {
                                affected.Add(i);
                                if (!i.Status.Additions.ContainsKey("Burning"))
                                {
