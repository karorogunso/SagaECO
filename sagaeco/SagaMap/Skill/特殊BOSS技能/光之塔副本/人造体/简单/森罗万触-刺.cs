    ...
    public class S31036 : ISkill
    {
            ...
            public override void CallBack()
            {
                try
                {
                    ...
                    foreach (var item in actors)
                    {
                        ...
                        Stone st = new Stone(skill.skill, item, 6000);
        ...
        private class Activator2 : MultiRunTask
        {
            ...
            public override void CallBack()
            {
                ...
                {
                    int damage = 2000;
                    ATKDOWN ad = new ATKDOWN(null, dActor, 15000, 80);
                    MATKDOWN md = new MATKDOWN(null, dActor, 15000, 80);
