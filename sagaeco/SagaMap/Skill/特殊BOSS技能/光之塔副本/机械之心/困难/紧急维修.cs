...
namespace SagaMap.Skill.SkillDefinations
{
    public class S31062 : ISkill
    {
        ...
        public void Proc(Actor sActor, Actor dActor, SkillArg args, byte level)
        {
            ...
            {
                ActorMob mob = map.SpawnCustomMob(10000000, sActor.MapID, 30330000, 0, 0, x, y, 10, 1, 0, 冰棍Info(), 冰棍AI(), Ondie, 1)[0];
                actorMobs.Add(mob);
        ...
        private class Activator : MultiRunTask
        {
            ...
            public override void CallBack()
            {
                ...
                if (caster.HP > 0)
                {
                    ...
                    int heal = (int)(caster.MaxHP * 0.1f);
                    if (count > 0)
                        heal = (int)(caster.MaxHP * 0.25f);
