...
namespace SagaMap.Skill.SkillDefinations
{
    public class S31063: ISkill
    {
        ...
        {
            if (sActor.Status.Additions.ContainsKey("老二刀片CD")) return;
            OtherAddition ss = new OtherAddition(null, sActor, "老二刀片CD", 70000);
            SkillHandler.ApplyAddition(sActor, ss);
            ...
            public override void CallBack()
            {
                ...
                try
                {
                    ...
                    if (count < countMax)
                    {
                        ...
                        SkillHandler.Instance.ShowVessel(mob, 0, 30, 0);
                    }
                    else
                    {
                        if (caster.type == ActorType.MOB)
