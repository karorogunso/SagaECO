...
namespace SagaMap.Skill.SkillDefinations
{
    public class S31022 : ISkill
    {
        ...
        public void Proc(Actor sActor, Actor dActor, SkillArg args, byte level)
        {
            ...
            暗鬼 = map.SpawnCustomMob(10680900, sActor.MapID, x, y, 5, 1, 0, 暗鬼Info(), 暗鬼AI())[0];
            ...
            明鬼 = map.SpawnCustomMob(10680300, sActor.MapID, x, y, 5, 1, 0, 明鬼Info(), 明鬼AI())[0];
                ...
                if (caster.Slave.Count > 0)
                {
                    foreach (var item in caster.Slave)
                    {
                        ...
                        if (mob.MobID == 10680300 && mob.HP > 0 && !mob.Buff.Dead)
                        {
                            ...
                            int hpheal = (int)(caster.MaxHP * 0.2f);
