        ...
        private class Activator : MultiRunTask
        {
            ...
            public override void CallBack()
            {
                try
                {
                    ...
                    ActorMob mob = map.SpawnCustomMob(10560000, map.ID,18610000,0,0,x,y,0,1,0, 孤魂info(caster), 孤魂ai(),null,0)[0];
            ...
            ActorMob.MobInfo 孤魂info(Actor boss)
            {
                ActorMob.MobInfo info = new ActorMob.MobInfo();
                info.name = "鬼之影";
                info.maxhp = (uint)(boss.MaxHP * 0.15f);
                info.speed = 500;
                info.atk_min = boss.Status.min_atk1;
                info.atk_max = boss.Status.max_atk1;
                info.matk_min = 1;
                info.matk_max = 1;
                info.def = 10;
                info.def_add = 10;
