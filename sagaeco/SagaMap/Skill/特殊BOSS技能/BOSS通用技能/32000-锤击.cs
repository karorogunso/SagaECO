...
namespace SagaMap.Skill.SkillDefinations
{
    public class S32000 : ISkill
    {
        ...
        public void Proc(Actor sActor, Actor dActor, SkillArg args, byte level)
        {
            ...
            /*-------------------魔法阵的技能体-----------------*/
            ActorSkill actor2 = new ActorSkill(SagaDB.Skill.SkillFactory.Instance.GetSkill(31133, 1), sActor);
            ...
            锤击 skill = new 锤击(sActor, actor2);
            skill.Activate();

        }
        class 锤击 : MultiRunTask
        {
            Actor sActor;
            Map map;
            ...
            byte x, y;
            public 锤击(Actor sActor, ActorSkill actorSkill)
            {
                ActorSkill = actorSkill;
                dueTime = 1500;
                this.sActor = sActor;
            ...
            public override void CallBack()
            {
                try
                {
                    ...
                    SkillHandler.Instance.ShowEffect(map, sActor, x, y, 5042);
                    ...
                    foreach (var item in actors)
                    {
                        ...
                        {
                            SkillHandler.Instance.DoDamage(true, sActor, item, null, SkillHandler.DefType.Def, Elements.Fire, 50, 2f);
                        }
                    }
                    Deactivate();//结束定时器
                }
