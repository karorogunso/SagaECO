...
namespace SagaMap.Skill.Additions.Global
{
    ...
    public class Berserk : DefaultBuff 
    {
        ...
        void StartEvent(Actor actor, DefaultBuff skill)
        {
            ...
            //最大攻擊
            int max_atk1_add = (int)(actor.Status.max_atk_bs );
            ...
            //最大攻擊
            int max_atk2_add = (int)(actor.Status.max_atk_bs);
            ...
            //最大攻擊
            int max_atk3_add = (int)(actor.Status.max_atk_bs);
            ...
            //最小攻擊
            int min_atk1_add = (int)(actor.Status.min_atk_bs);
            ...
            //最小攻擊
            int min_atk2_add = (int)(actor.Status.min_atk_bs);
            ...
            //最小攻擊
            int min_atk3_add = (int)(actor.Status.min_atk_bs);
            ...
            //右防禦
            int def_add_add = -(int)(actor.Status.def_add_bs);
