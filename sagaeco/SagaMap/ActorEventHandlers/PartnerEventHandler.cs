...
namespace SagaMap.ActorEventHandlers
{
    public class PartnerEventHandler : ActorEventHandler
    {
        ...
        {
            if (!partner.VisibleActors.ContainsKey(aActor.ActorID))
                partner.VisibleActors.Add(aActor.ActorID, aActor.ActorID);
        ...
        {
            if (partner.VisibleActors.ContainsKey(dActor.ActorID))
