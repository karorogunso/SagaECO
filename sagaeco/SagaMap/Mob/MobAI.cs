...
namespace SagaMap.Mob
{
    ...
    public partial class MobAI
    {
        ...
        public IConcurrentDictionary<string, AICommand> commands = new IConcurrentDictionary<string, AICommand>();
        Dictionary<int, MapNode> openedNode = new Dictionary<int, MapNode>();
        public IConcurrentDictionary<uint, uint> Hate = new IConcurrentDictionary<uint, uint>();
        ...
        //伤害表，掉宝归属
        public IConcurrentDictionary<uint, int> DamageTable = new IConcurrentDictionary<uint, int>();
        ...
        public bool CanMove
        {
            get
            {
                return !(this.Mode.NoMove || Mob.Buff.CannotMove || Mob.Buff.Stun || Mob.Buff.Stone || Mob.Buff.Frosen ||
                    Mob.Buff.硬直 || this.Mob.Tasks.ContainsKey("SkillCast"));
            }
        }
        ...
        public bool CanAttack
        {
            get
            {
                return !(this.Mode.NoAttack || Mob.Buff.Stone || Mob.Buff.Stun || Mob.Buff.Frosen ||this.Mob.Tasks.ContainsKey("SkillCast"));
            }
        }
        public bool CanUseSkill
        {
            get
            {
                if (Mob.Buff.Silence)
                    return false;
                else if (Global.Random.Next(0, 100) < 20)
        ...
        public void Start()
        {
            ...
            this.commands = new IConcurrentDictionary<string, AICommand>();
            this.commands.Add("Attack", new AICommands.Attack(this));
