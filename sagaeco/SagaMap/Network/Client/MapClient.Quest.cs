...
namespace SagaMap.Network.Client
{
    public partial class MapClient
    {
        ...
        public void OnDailyDungeonOpen()
        {
            ...
            {
                SendSystemMessage("每日地牢无法在23:00~23:59期间打开了哦。");
                return;
            }
        ...
        public void SendQuestPoints()
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        ushort QuestPointAdd = (ushort)Math.Min(((hours / Configuration.Instance.QuestUpdateTime) + 1) * Configuration.Instance.QuestUpdateAmount, Configuration.Instance.QuestPointsMax - Character.QuestRemaining);
                        Character.QuestRemaining += QuestPointAdd;
                        Character.QuestNextResetTime = Character.QuestNextResetTime + new TimeSpan(0, ((hours / Configuration.Instance.QuestUpdateTime) + 1) * Configuration.Instance.QuestUpdateTime, 0, 0);
