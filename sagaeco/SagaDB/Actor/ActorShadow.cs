...
namespace SagaDB.Actor
{
    public class ActorShadow : ActorPet
    {
        public ActorShadow(ActorPC creator)
        {
            ...
            this.Status.min_atk1 = 0;
            this.Status.max_atk1 = 0;
            this.Status.min_atk2 = 0;
            this.Status.max_atk2 = 0;
            this.Status.min_atk3 = 0;
            this.Status.max_atk3 = 0;
            this.Status.min_matk = 0;
            this.Status.max_matk = 0;
