...
namespace SagaDB.Actor
{
    ...
    public class Appearance
    {
        ...
        //null时隐藏（设置为0），不存在时跳过
        IConcurrentDictionary<EnumEquipSlot, Item.Item> equips = new IConcurrentDictionary<EnumEquipSlot, Item.Item>();
        ...
        public uint MarionettePictID { get { return marionettePictID; } set { marionettePictID = value; } }
        public IConcurrentDictionary<EnumEquipSlot, Item.Item> Equips { get { return equips; } set { equips = value; } }
    ...
    public class ActorPC : Actor, IStats
    {
        ...
        public DateTime LastAttackTime = DateTime.Now;
        ...
        public IConcurrentDictionary<string, DateTime> PendingAddtions = new IConcurrentDictionary<string, DateTime>();

        public List<uint> InstanceMapIDs = new List<uint>();
        ...
        Dictionary<uint, Skill.Skill> skills = new Dictionary<uint, Skill.Skill>();
        Dictionary<uint, Skill.Skill> skills2 = new Dictionary<uint, Skill.Skill>();
        Dictionary<uint, Skill.Skill> skillsReserve = new Dictionary<uint, Skill.Skill>();
        Dictionary<uint, Skill.Skill> skills2_1 = new Dictionary<uint, Skill.Skill>();
        Dictionary<uint, Skill.Skill> skills2_2 = new Dictionary<uint, Skill.Skill>();
        Dictionary<uint, Skill.Skill> skills3 = new Dictionary<uint, Skill.Skill>();
        Dictionary<uint, Skill.Skill> skillsEquip = new Dictionary<uint, Skill.Skill>();
        Dictionary<uint, Skill.Skill> skillstemp = new Dictionary<uint, Skill.Skill>();
        Dictionary<uint, Skill.Skill> skills2temp = new Dictionary<uint, Skill.Skill>();
        Dictionary<uint, Skill.Skill> skillsReservetemp = new Dictionary<uint, Skill.Skill>();
        Dictionary<uint, Skill.Skill> skills2_1temp = new Dictionary<uint, Skill.Skill>();
        Dictionary<uint, Skill.Skill> skills2_2temp = new Dictionary<uint, Skill.Skill>();
        Dictionary<uint, Skill.Skill> skills3temp = new Dictionary<uint, Skill.Skill>();
        Dictionary<uint, Skill.Skill> skillsEquiptemp = new Dictionary<uint, Skill.Skill>();
        /// <summary>
        ...
        /// 1转职业技能
        /// </summary>
        public Dictionary<uint, Skill.Skill> Skills
        {
            get
            {
                if (TInt["大逃杀模式"] == 1)
        ...
        /// 2转职业技能
        /// </summary>
        public Dictionary<uint, Skill.Skill> Skills2
        {
            get
            {
                if (TInt["大逃杀模式"] == 1)
        ...
        /// 2转职业保留技能
        /// </summary>
        public Dictionary<uint, Skill.Skill> SkillsReserve
        {
            get
            {
                if (TInt["大逃杀模式"] == 1)
                    return skillsReservetemp;
        ...
        /// 2-1职业技能
        /// </summary>
        public Dictionary<uint, Skill.Skill> Skills2_1
        {
            get
            {
                if (TInt["大逃杀模式"] == 1)
                    return skills2_1temp;
                return skills2_1;
            }
            set
            {
        ...
        /// 2-2职业技能
        /// </summary>
        public Dictionary<uint, Skill.Skill> Skills2_2
        {
            get
            {
                if (TInt["大逃杀模式"] == 1)
                    return skills2_2temp;
                return skills2_2;
            }
            set
            {
        ...
        /// 3转职业技能
        /// </summary>
        public Dictionary<uint, Skill.Skill> Skills3
        {
            get
            {
                if (TInt["大逃杀模式"] == 1)
        ...
        /// 装备、临时技能
        /// </summary>
        public Dictionary<uint, Skill.Skill> SkillsEquip
        {
            get
            {
                if (TInt["大逃杀模式"] == 1)
                    return skillsEquiptemp;
                return skillsEquip;
            }
            set
            {
        ...
        public ActorPC()
        {
            ...
            inventoryTemp = new Inventory(this);
        ...
        public ushort QuestRemaining
        {
            ...
            set
            {
                int balance = (int)(value - AInt["剩余任务点数"]);
                AInt["剩余任务点数"] = value;
                if (e != null)
                    e.PropertyUpdate(UpdateEvent.QUEST_POINT, balance);
            }
        }
        ...
        public ushort Str
        {
            ...
            set
            {
                ...
                {
                    Map.MapInfo map = Map.MapInfoFactory.Instance.MapInfo[this.MapID];
                    if (map.Flag.Test(SagaDB.Map.MapFlags.Dominion) || TInt["大逃杀模式"] == 1)
                        this.dstr = value;
                    else
                        this.str = value;
                }
        ...
        /// 剩余1转技能点
        /// </summary>
        public ushort SkillPoint { get { return this.SkillPoint3; } set { this.SkillPoint3 = value; if (e != null) e.PropertyUpdate(UpdateEvent.STAT_POINT, 0); } }
        /// <summary>
        /// 剩余2－1技能点
        /// </summary>
        public ushort SkillPoint2X { get { return this.SkillPoint3; } set { this.SkillPoint3 = value; if (e != null) e.PropertyUpdate(UpdateEvent.STAT_POINT, 0); } }
        /// <summary>
        /// 剩余2－2技能点
        /// </summary>
        public ushort SkillPoint2T { get { return this.SkillPoint3; } set { this.SkillPoint3 = value; if (e != null) e.PropertyUpdate(UpdateEvent.STAT_POINT, 0); } }
        ...
        public MotionType Motion {
            ...
            {
                motion = value;
                if(value != 0 && value != (MotionType)111)
                if (e != null) e.PropertyUpdate(UpdateEvent.MOTION, 0);
            }
        }
        public byte EMotion;
