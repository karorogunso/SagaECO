...
namespace SagaWorld
{
    public class WorldServer
    {
        ...
        static void Main(string[] args)
        {
            ...
            Logger Log = new Logger("SagaWorld.log");
            ...
            Configuration.Instance.Initialization("./Config/SagaWorld.xml");
            ...
            WorldClientManager.Instance.Start();
            if (!WorldClientManager.Instance.StartNetwork(12000))
            {
            ...
            Global.clientMananger = (ClientManager)WorldClientManager.Instance;
            ...
            while (true)
            {
                ...
                WorldClientManager.Instance.NetworkLoop(10);
