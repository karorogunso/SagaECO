namespace Eco
{
    ...
    public class Texture
    {
        ...
        private Texture(string FileName)
        {
            ...
            this._Texture = Load(FileName, ref this._SplitState);
        }
        ...
        private static bool IsEcoTexture(string FileName)
        {
        ...
        public static System.Drawing.Image Load(string FileName)
        {
            SplitState splitState = null;
            return Load(FileName, ref splitState);
        }

        public static System.Drawing.Image Load(string FileName, ref SplitState SplitState)
        {
            ...
            catch (Exception exception1)
            {
                ...
                try
                {
                    if (IsEcoTexture(FileName))
                    {
                        image = LoadEcoTexture(FileName, ref SplitState);
                        if (image == null)
                        {
                            SplitState = null;
                        }
        ...
        private static Bitmap LoadEcoTexture(string FileName, ref SplitState SplitState)
        {
            Bitmap bitmap;
            FileStream input = new FileStream(FileName, FileMode.Open, FileAccess.Read);
            BinaryReader reader = new BinaryReader(input);
